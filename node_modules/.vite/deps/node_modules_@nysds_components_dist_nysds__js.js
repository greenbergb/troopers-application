...
// node_modules/@nysds/components/dist/nysds.js
var require_nysds = __commonJS({
  "node_modules/@nysds/components/dist/nysds.js"(exports, module) {
    (function(v, ue) {
      typeof exports == "object" && typeof module < "u" ? ue(exports) : typeof define == "function" && define.amd ? define(["exports"], ue) : (v = typeof globalThis < "u" ? globalThis : v || self, ue(v.NYSDS = {}));
    })(exports, function(v) {
      "use strict";
      var g1, Ce, V, N, ae, le, me, xe, ce, m, de, Y, K, he;
      const ue = globalThis, dt = ue.ShadowRoot && (ue.ShadyCSS === void 0 || ue.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, ht = Symbol(), Zt = /* @__PURE__ */ new WeakMap();
      let Ot = class {
        constructor(e, t, o) {
          if (this._$cssResult$ = true, o !== ht) throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");
        ...
        get styleSheet() {
          ...
          if (dt && e === void 0) {
            ...
            o && (e = Zt.get(t)), e === void 0 && ((this.o = e = new CSSStyleSheet()).replaceSync(this.cssText), o && Zt.set(t, e));
          }
          return e;
        }
        toString() {
      ...
      const C1 = (a) => new Ot(typeof a == "string" ? a : a + "", void 0, ht), g = (a, ...e) => {
        const t = a.length === 1 ? a[0] : e.reduce((o, s, r) => o + ((n) => {
          if (n._$cssResult$ === true) return n.cssText;
          if (typeof n == "number") return n;
          throw Error("Value passed to 'css' function must be a 'css' function result: " + n + ". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.");
        })(s) + a[r + 1], a[0]);
        return new Ot(t, a, ht);
      }, m1 = (a, e) => {
        if (dt) a.adoptedStyleSheets = e.map((t) => t instanceof CSSStyleSheet ? t : t.styleSheet);
        else for (const t of e) {
          const o = document.createElement("style"), s = ue.litNonce;
          s !== void 0 && o.setAttribute("nonce", s), o.textContent = t.cssText, a.appendChild(o);
        }
      }, Ut = dt ? (a) => a : (a) => a instanceof CSSStyleSheet ? ((e) => {
        let t = "";
        for (const o of e.cssRules) t += o.cssText;
        return C1(t);
      })(a) : a;
      const { is: x1, defineProperty: w1, getOwnPropertyDescriptor: k1, getOwnPropertyNames: $1, getOwnPropertySymbols: S1, getPrototypeOf: L1 } = Object, pe = globalThis, qt = pe.trustedTypes, E1 = qt ? qt.emptyScript : "", yt = pe.reactiveElementPolyfillSupport, qe = (a, e) => a, tt = { toAttribute(a, e) {
        switch (e) {
          case Boolean:
            a = a ? E1 : null;
            break;
        ...
        return t;
      } }, ut = (a, e) => !x1(a, e), Tt = { attribute: true, type: String, converter: tt, reflect: false, hasChanged: ut };
      ...
      class He extends HTMLElement {
        ...
        static createProperty(e, t = Tt) {
          if (t.state && (t.attribute = false), this._$Ei(), this.elementProperties.set(e, t), !t.noAccessor) {
            ...
            s !== void 0 && w1(this.prototype, e, s);
          }
        }
        static getPropertyDescriptor(e, t, o) {
          const { get: s, set: r } = k1(this.prototype, e) ?? { get() {
            return this[t];
          }, set(n) {
            this[t] = n;
          } };
        ...
        static finalize() {
          ...
          if (this.finalized = true, this._$Ei(), this.hasOwnProperty(qe("properties"))) {
            const t = this.properties, o = [...$1(t), ...S1(t)];
        ...
        static finalizeStyles(e) {
          ...
          if (Array.isArray(e)) {
            ...
            for (const s of o) t.unshift(Ut(s));
          } else e !== void 0 && t.push(Ut(e));
          return t;
        }
        static _$Eu(e, t) {
          const o = t.attribute;
          return o === false ? void 0 : typeof o == "string" ? o : typeof e == "string" ? e.toLowerCase() : void 0;
        }
        constructor() {
        ...
        createRenderRoot() {
          ...
          return m1(e, this.constructor.elementStyles), e;
        }
        connectedCallback() {
          var e;
        ...
        _$EC(e, t) {
          ...
          if (s !== void 0 && o.reflect === true) {
            const n = (((r = o.converter) == null ? void 0 : r.toAttribute) !== void 0 ? o.converter : tt).toAttribute(t, o.type);
        ...
        _$AK(e, t) {
          ...
          if (s !== void 0 && this._$Em !== s) {
            const n = o.getPropertyOptions(s), d = typeof n.converter == "function" ? { fromAttribute: n.converter } : ((r = n.converter) == null ? void 0 : r.fromAttribute) !== void 0 ? n.converter : tt;
            this._$Em = s, this[s] = d.fromAttribute(t, n.type), this._$Em = null;
          }
        }
        requestUpdate(e, t, o) {
          if (e !== void 0) {
            if (o ?? (o = this.constructor.getPropertyOptions(e)), !(o.hasChanged ?? ut)(this[e], t)) return;
            this.P(e, t, o);
          }
          this.isUpdatePending === false && (this._$ES = this._$ET());
        }
        P(e, t, o) {
          this._$AL.has(e) || this._$AL.set(e, t), o.reflect === true && this._$Em !== e && (this._$Ej ?? (this._$Ej = /* @__PURE__ */ new Set())).add(e);
        }
        async _$ET() {
        ...
        performUpdate() {
          ...
          if (!this.hasUpdated) {
            ...
            if (s.size > 0) for (const [r, n] of s) n.wrapped !== true || this._$AL.has(r) || this[r] === void 0 || this.P(r, this[r], n);
          }
          let e = false;
          const t = this._$AL;
          try {
      ...
      He.elementStyles = [], He.shadowRootOptions = { mode: "open" }, He[qe("elementProperties")] = /* @__PURE__ */ new Map(), He[qe("finalized")] = /* @__PURE__ */ new Map(), yt == null || yt({ ReactiveElement: He }), (pe.reactiveElementVersions ?? (pe.reactiveElementVersions = [])).push("2.0.4");
...
\f\r"'\`<>=]|("|')|))|$)`, "g"), Wt = /'/g, Yt = /"/g, Kt = /^(?:script|style|textarea|title)$/i, M1 = (a) => (e, ...t) => ({ _$litType$: a, strings: e, values: t }), l = M1(1), Ie = Symbol.for("lit-noChange"), k = Symbol.for("lit-nothing"), Xt = /* @__PURE__ */ new WeakMap(), Se = ke.createTreeWalker(ke, 129);
      function Qt(a, e) {
        if (!pt(a) || !a.hasOwnProperty("raw")) throw Error("invalid template strings array");
        return Rt !== void 0 ? Rt.createHTML(e) : e;
      }
      const z1 = (a, e) => {
        const t = a.length - 1, o = [];
        let s, r = e === 2 ? "<svg>" : e === 3 ? "<math>" : "", n = Fe;
        for (let d = 0; d < t; d++) {
          const c = a[d];
          let y, p, h = -1, x = 0;
          for (; x < c.length && (n.lastIndex = x, p = n.exec(c), p !== null); ) x = n.lastIndex, n === Fe ? p[1] === "!--" ? n = jt : p[1] !== void 0 ? n = Gt : p[2] !== void 0 ? (Kt.test(p[2]) && (s = RegExp("</" + p[2], "g")), n = $e) : p[3] !== void 0 && (n = $e) : n === $e ? p[0] === ">" ? (n = s ?? Fe, h = -1) : p[1] === void 0 ? h = -2 : (h = n.lastIndex - p[2].length, y = p[1], n = p[3] === void 0 ? $e : p[3] === '"' ? Yt : Wt) : n === Yt || n === Wt ? n = $e : n === jt || n === Gt ? n = Fe : (n = $e, s = void 0);
          const E = n === $e && a[d + 1].startsWith("/>") ? " " : "";
          r += n === Fe ? c + D1 : h >= 0 ? (o.push(y), c.slice(0, h) + Nt + c.slice(h) + ve + E) : c + ve + (h === -2 ? d : E);
        }
        return [Qt(a, r + (a[t] || "<?>") + (e === 2 ? "</svg>" : e === 3 ? "</math>" : "")), o];
      };
      class je {
        constructor({ strings: e, _$litType$: t }, o) {
          ...
          this.parts = [];
          let r = 0, n = 0;
          const d = e.length - 1, c = this.parts, [y, p] = z1(e, t);
          if (this.el = je.createElement(y, o), Se.currentNode = this.el.content, t === 2 || t === 3) {
            const h = this.el.content.firstChild;
            h.replaceWith(...h.childNodes);
          }
          for (; (s = Se.nextNode()) !== null && c.length < d; ) {
            if (s.nodeType === 1) {
              if (s.hasAttributes()) for (const h of s.getAttributeNames()) if (h.endsWith(Nt)) {
                const x = p[n++], E = s.getAttribute(h).split(ve), ye = /([.?@])?(.*)/.exec(x);
                c.push({ type: 1, index: r, name: ye[2], strings: E, ctor: ye[1] === "." ? H1 : ye[1] === "?" ? I1 : ye[1] === "@" ? B1 : ot }), s.removeAttribute(h);
              } else h.startsWith(ve) && (c.push({ type: 6, index: r }), s.removeAttribute(h));
              if (Kt.test(s.tagName)) {
                const h = s.textContent.split(ve), x = h.length - 1;
                if (x > 0) {
                  s.textContent = st ? st.emptyScript : "";
                  for (let E = 0; E < x; E++) s.append(h[E], Re()), Se.nextNode(), c.push({ type: 2, index: ++r });
                  s.append(h[x], Re());
                }
              }
            } else if (s.nodeType === 8) if (s.data === Ft) c.push({ type: 2, index: r });
            else {
              let h = -1;
              for (; (h = s.data.indexOf(ve, h + 1)) !== -1; ) c.push({ type: 7, index: r }), h += ve.length - 1;
            }
            r++;
          }
        }
      ...
      function Be(a, e, t = a, o) {
        var n, d;
        if (e === Ie) return e;
        let s = o !== void 0 ? (n = t._$Co) == null ? void 0 : n[o] : t._$Cl;
        const r = Ne(e) ? void 0 : e._$litDirective$;
        return (s == null ? void 0 : s.constructor) !== r && ((d = s == null ? void 0 : s._$AO) == null || d.call(s, false), r === void 0 ? s = void 0 : (s = new r(a), s._$AT(a, t, o)), o !== void 0 ? (t._$Co ?? (t._$Co = []))[o] = s : t._$Cl = s), s !== void 0 && (e = Be(a, s._$AS(a, e.values), s, o)), e;
      }
      class V1 {
        constructor(e, t) {
        ...
        u(e) {
          const { el: { content: t }, parts: o } = this._$AD, s = ((e == null ? void 0 : e.creationScope) ?? ke).importNode(t, true);
          Se.currentNode = s;
          let r = Se.nextNode(), n = 0, d = 0, c = o[0];
          for (; c !== void 0; ) {
            if (n === c.index) {
              let y;
              c.type === 2 ? y = new Ge(r, r.nextSibling, this, e) : c.type === 1 ? y = new c.ctor(r, c.name, c.strings, this, e) : c.type === 6 && (y = new P1(r, this, e)), this._$AV.push(y), c = o[++d];
            }
            n !== (c == null ? void 0 : c.index) && (r = Se.nextNode(), n++);
          }
          return Se.currentNode = ke, s;
        }
        p(e) {
          let t = 0;
      ...
      class Ge {
        ...
        constructor(e, t, o, s) {
          this.type = 2, this._$AH = k, this._$AN = void 0, this._$AA = e, this._$AB = t, this._$AM = o, this.options = s, this._$Cv = (s == null ? void 0 : s.isConnected) ?? true;
        }
        get parentNode() {
        ...
        _$AI(e, t = this) {
          e = Be(this, e, t), Ne(e) ? e === k || e == null || e === "" ? (this._$AH !== k && this._$AR(), this._$AH = k) : e !== this._$AH && e !== Ie && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : A1(e) ? this.k(e) : this._(e);
        }
        O(e) {
        ...
        _(e) {
          this._$AH !== k && Ne(this._$AH) ? this._$AA.nextSibling.data = e : this.T(ke.createTextNode(e)), this._$AH = e;
        }
        $(e) {
          var r;
          const { values: t, _$litType$: o } = e, s = typeof o == "number" ? this._$AC(e) : (o.el === void 0 && (o.el = je.createElement(Qt(o.h, o.h[0]), this.options)), o);
          if (((r = this._$AH) == null ? void 0 : r._$AD) === s) this._$AH.p(t);
          else {
            const n = new V1(s, this), d = n.u(this.options);
            n.p(t), this.T(d), this._$AH = n;
          }
        }
        _$AC(e) {
          let t = Xt.get(e.strings);
          return t === void 0 && Xt.set(e.strings, t = new je(e)), t;
        }
        k(e) {
          pt(this._$AH) || (this._$AH = [], this._$AR());
          const t = this._$AH;
          let o, s = 0;
          for (const r of e) s === t.length ? t.push(o = new Ge(this.O(Re()), this.O(Re()), this, this.options)) : o = t[s], o._$AI(r), s++;
          s < t.length && (this._$AR(o && o._$AB.nextSibling, s), t.length = s);
        }
        _$AR(e = this._$AA.nextSibling, t) {
          var o;
          for ((o = this._$AP) == null ? void 0 : o.call(this, false, true, t); e && e !== this._$AB; ) {
      ...
      class ot {
        ...
        constructor(e, t, o, s, r) {
          this.type = 1, this._$AH = k, this._$AN = void 0, this.element = e, this.name = t, this._$AM = s, this.options = r, o.length > 2 || o[0] !== "" || o[1] !== "" ? (this._$AH = Array(o.length - 1).fill(new String()), this.strings = o) : this._$AH = k;
        }
        _$AI(e, t = this, o, s) {
          const r = this.strings;
          let n = false;
          if (r === void 0) e = Be(this, e, t, 0), n = !Ne(e) || e !== this._$AH && e !== Ie, n && (this._$AH = e);
          else {
            const d = e;
            let c, y;
            for (e = r[0], c = 0; c < r.length - 1; c++) y = Be(this, d[o + c], t, c), y === Ie && (y = this._$AH[c]), n || (n = !Ne(y) || y !== this._$AH[c]), y === k ? e = k : e !== k && (e += (y ?? "") + r[c + 1]), this._$AH[c] = y;
          }
          n && !s && this.j(e);
        }
        j(e) {
      ...
      class B1 extends ot {
        ...
        _$AI(e, t = this) {
          if ((e = Be(this, e, t, 0) ?? k) === Ie) return;
          const o = this._$AH, s = e === k && o !== k || e.capture !== o.capture || e.once !== o.once || e.passive !== o.passive, r = e !== k && (o === k || s);
      ...
      const ft = Te.litHtmlPolyfillSupport;
      ft == null || ft(je, Ge), (Te.litHtmlVersions ?? (Te.litHtmlVersions = [])).push("3.2.1");
      const Z1 = (a, e, t) => {
        const o = (t == null ? void 0 : t.renderBefore) ?? e;
        let s = o._$litPart$;
        if (s === void 0) {
          const r = (t == null ? void 0 : t.renderBefore) ?? null;
          o._$litPart$ = s = new Ge(e.insertBefore(Re(), r), r, void 0, t ?? {});
        }
        return s._$AI(a), s;
      };
      let f = class extends He {
        ...
        update(e) {
          const t = this.render();
          this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(e), this._$Do = Z1(t, this.renderRoot, this.renderOptions);
        }
        connectedCallback() {
          var e;
      ...
      f._$litElement$ = true, f.finalized = true, (g1 = globalThis.litElementHydrateSupport) == null || g1.call(globalThis, { LitElement: f });
      const gt = globalThis.litElementPolyfillSupport;
      gt == null || gt({ LitElement: f }), (globalThis.litElementVersions ?? (globalThis.litElementVersions = [])).push("4.1.1");
      const O1 = { attribute: true, type: String, converter: tt, reflect: false, hasChanged: ut }, U1 = (a = O1, e, t) => {
        const { kind: o, metadata: s } = t;
        let r = globalThis.litPropertyMetadata.get(s);
        if (r === void 0 && globalThis.litPropertyMetadata.set(s, r = /* @__PURE__ */ new Map()), r.set(t.name, a), o === "accessor") {
          const { name: n } = t;
          return { set(d) {
            const c = e.get.call(this);
            e.set.call(this, d), this.requestUpdate(n, c, a);
          }, init(d) {
        ...
        if (o === "setter") {
          ...
          return function(d) {
            const c = this[n];
            e.call(this, d), this.requestUpdate(n, c, a);
          };
        }
        throw Error("Unsupported decorator location: " + o);
      };
      function i(a) {
        return (e, t) => typeof t == "object" ? U1(a, e, t) : ((o, s, r) => {
          const n = s.hasOwnProperty(r);
          return s.constructor.createProperty(r, n ? { ...o, wrapped: true } : o), n ? Object.getOwnPropertyDescriptor(s, r) : void 0;
        })(a, e, t);
      }
      function D(a) {
        return i({ ...a, state: true, attribute: false });
      }
      const q1 = (a, e, t) => (t.configurable = true, t.enumerable = true, Reflect.decorate && typeof e != "object" && Object.defineProperty(a, e, t), t);
      function T1(a, e) {
        return (t, o, s) => {
          const r = (n) => {
            var d;
            return ((d = n.renderRoot) == null ? void 0 : d.querySelector(a)) ?? null;
          };
          return q1(t, o, { get() {
            return r(this);
          } });
...
`;
      var R1 = Object.defineProperty, We = (a, e, t, o) => {
        for (var s = void 0, r = a.length - 1, n; r >= 0; r--) (n = a[r]) && (s = n(e, t, s) || s);
        return s && R1(e, t, s), s;
      };
      let N1 = 0;
      const mt = class mt extends f {
        constructor() {
          super(), this.id = "", this.heading = "", this.expanded = false, this.bordered = false;
        }
        connectedCallback() {
        ...
        _generateUniqueId() {
          return `nys-accordionitem-${Date.now()}-${N1++}`;
        }
        _dispatchEvent() {
          this.dispatchEvent(new CustomEvent("nys-accordionitem-toggle", { detail: { id: this.id, heading: this.heading, expanded: this.expanded }, bubbles: true, composed: true }));
        }
        _handleExpand() {
        ...
        _updateHeight() {
          if (this._contentContainer) if (this.expanded) {
            const e = this._contentContainer.scrollHeight;
            this._contentContainer.style.height = `${e}px`;
          } else this._contentContainer.style.height = "0", this._contentContainer.style.overflow = "hidden";
        }
        render() {
    ...
    <div id=${this.id} class="nys-accordionitem">
      ...
      mt.styles = Jt;
      let te = mt;
      We([i({ type: String })], te.prototype, "id"), We([i({ type: String })], te.prototype, "heading"), We([i({ type: Boolean, reflect: true })], te.prototype, "expanded"), We([i({ type: Boolean, reflect: true })], te.prototype, "bordered"), We([T1(".nys-accordionitem__content")], te.prototype, "_contentContainer"), customElements.get("nys-accordionitem") || customElements.define("nys-accordionitem", te);
      var F1 = Object.defineProperty, bt = (a, e, t, o) => {
        for (var s = void 0, r = a.length - 1, n; r >= 0; r--) (n = a[r]) && (s = n(e, t, s) || s);
        return s && F1(e, t, s), s;
      };
      let j1 = 0;
      const xt = class xt extends f {
        constructor() {
          super(), this.id = "", this.singleSelect = false, this.bordered = false;
        }
        connectedCallback() {
          super.connectedCallback(), this.id || (this.id = this._generateUniqueId());
        }
        ...
        _getAccordions() {
          ...
          return ((e == null ? void 0 : e.assignedElements()) || []).filter((s) => s.tagName.toLowerCase() === "nys-accordionitem");
        }
        _onAccordionToggle(e) {
          if (!this.singleSelect) return;
          const t = e.detail.id;
          e.detail.expanded && this._getAccordions().forEach((s) => {
            s.id !== t && s.expanded && (s.expanded = false);
          });
        }
        _applyBordered() {
    ...
    >
      ...
      xt.styles = Jt;
      let Le = xt;
      bt([i({ type: String })], Le.prototype, "id"), bt([i({ type: Boolean, reflect: true })], Le.prototype, "singleSelect"), bt([i({ type: Boolean, reflect: true })], Le.prototype, "bordered"), customElements.get("nys-accordion") || customElements.define("nys-accordion", Le);
      const G1 = g`
  :host {
    /* Global Alert Styles */
...
`;
      const u = (a) => a ?? k;
      var W1 = Object.defineProperty, Y1 = Object.getOwnPropertyDescriptor, U = (a, e, t, o) => {
        for (var s = o > 1 ? void 0 : o ? Y1(e, t) : e, r = a.length - 1, n; r >= 0; r--) (n = a[r]) && (s = (o ? n(e, t, s) : n(s)) || s);
        return o && s && W1(e, t, s), s;
      };
      let K1 = 0;
      const H = (Ce = class extends f {
        constructor() {
          super(...arguments), this.id = "", this.heading = "", this.icon = "", this.dismissible = false, this.duration = 0, this.text = "", this.primaryAction = "", this.secondaryAction = "", this.primaryLabel = "Learn more", this.secondaryLabel = "Dismiss", this._alertClosed = false, this._slotHasContent = true, this._type = "base", this._timeoutId = null;
        }
        get type() {
          return this._type;
        }
        set type(e) {
          this._type = Ce.VALID_TYPES.includes(e) ? e : "base";
        }
        get ariaAttributes() {
        ...
        _closeAlert() {
          this._alertClosed = true, this.dispatchEvent(new CustomEvent("nys-close", { detail: { id: this.id, type: this.type, label: this.heading }, bubbles: true, composed: true }));
        }
        async _checkSlotContent() {
          var t;
          const e = (t = this.shadowRoot) == null ? void 0 : t.querySelector("slot");
          if (e) {
            const o = e.assignedNodes({ flatten: true }).filter((s) => {
              var r;
          ...
          } else await Promise.resolve(), this._slotHasContent = false;
        }
        render() {
          var o, s;
    ...
    `;
      ...
      }, Ce.styles = G1, Ce.VALID_TYPES = ["base", "info", "success", "warning", "danger", "emergency"], Ce);
      U([i({ type: String })], H.prototype, "id", 2), U([i({ type: String })], H.prototype, "heading", 2), U([i({ type: String })], H.prototype, "icon", 2), U([i({ type: Boolean, reflect: true })], H.prototype, "dismissible", 2), U([i({ type: Number, reflect: true })], H.prototype, "duration", 2), U([i({ type: String })], H.prototype, "text", 2), U([i({ type: String })], H.prototype, "primaryAction", 2), U([i({ type: String })], H.prototype, "secondaryAction", 2), U([i({ type: String })], H.prototype, "primaryLabel", 2), U([i({ type: String })], H.prototype, "secondaryLabel", 2), U([D()], H.prototype, "_alertClosed", 2), U([D()], H.prototype, "_slotHasContent", 2), U([i({ reflect: true })], H.prototype, "type", 1);
      let e1 = H;
      customElements.get("nys-alert") || customElements.define("nys-alert", e1);
      const X1 = g`
  :host {
...
`;
      var Q1 = Object.defineProperty, X = (a, e, t, o) => {
        for (var s = void 0, r = a.length - 1, n; r >= 0; r--) (n = a[r]) && (s = n(e, t, s) || s);
        return s && Q1(e, t, s), s;
      };
      let J1 = 0;
      const wt = class wt extends f {
        constructor() {
          super(...arguments), this.id = "", this.ariaLabel = "", this.image = "", this.initials = "", this.icon = "", this.color = "", this.interactive = false, this.disabled = false, this.lazy = false, this._slotHasContent = true;
        }
        connectedCallback() {
        ...
        async _checkSlotContent() {
          ...
          const t = e.assignedNodes({ flatten: true }).filter((s) => {
            var r;
            return s.nodeType === Node.ELEMENT_NODE || s.nodeType === Node.TEXT_NODE && ((r = s.textContent) == null ? void 0 : r.trim());
          });
        ...
        getContrastForeground() {
          ...
          const n = getComputedStyle(r).color;
          document.body.removeChild(r);
          const d = n.match(/\d+/g);
          if (!d) return;
          const c = Number(d[0]), y = Number(d[1]), p = Number(d[2]), x = (0.299 * c + 0.587 * y + 0.114 * p) / 255 < 0.5;
          return ((E = this.initials) == null ? void 0 : E.length) > 0 ? x ? s : o : x ? t : e;
        }
        render() {
          var e, t, o;
          return l`
    ...
    `;
      ...
      wt.styles = X1;
      let I = wt;
      X([i({ type: String })], I.prototype, "id"), X([i({ type: String })], I.prototype, "ariaLabel"), X([i({ type: String })], I.prototype, "image"), X([i({ type: String })], I.prototype, "initials"), X([i({ type: String })], I.prototype, "icon"), X([i({ type: String })], I.prototype, "color"), X([i({ type: Boolean, reflect: true })], I.prototype, "interactive"), X([i({ type: Boolean, reflect: true })], I.prototype, "disabled"), X([i({ type: Boolean, reflect: true })], I.prototype, "lazy"), X([D()], I.prototype, "_slotHasContent"), customElements.get("nys-avatar") || customElements.define("nys-avatar", I);
      const es = g`
  .nys-backtotop {
...
`;
      var ts = Object.defineProperty, rt = (a, e, t, o) => {
        for (var s = void 0, r = a.length - 1, n; r >= 0; r--) (n = a[r]) && (s = n(e, t, s) || s);
        return s && ts(e, t, s), s;
      };
      const kt = class kt extends f {
        constructor() {
          super(), this.position = "right", this.visible = false, this.isMobile = false, this.forceVisible = false, this._handleScroll = this._handleScroll.bind(this), this._handleResize = this._handleResize.bind(this), this.mediaQuery = window.matchMedia("(max-width: 480px)");
        }
        connectedCallback() {
        ...
        render() {
          const e = ["nys-backtotop", this.position, this.visible ? "visible" : ""].filter(Boolean).join(" ");
          return l`<nys-button
      id="nys-backtotop"
    ...
    ></nys-button>`;
      ...
      kt.styles = es;
      let fe = kt;
      rt([i({ type: String })], fe.prototype, "position"), rt([i({ type: Boolean, reflect: true })], fe.prototype, "visible"), rt([D()], fe.prototype, "isMobile"), rt([D()], fe.prototype, "forceVisible"), customElements.get("nys-backtotop") || customElements.define("nys-backtotop", fe);
      const ss = g`
  :host {
    /* Anything that can be overridden should be defined here */
...
`;
      var os = Object.defineProperty, rs = Object.getOwnPropertyDescriptor, w = (a, e, t, o) => {
        for (var s = o > 1 ? void 0 : o ? rs(e, t) : e, r = a.length - 1, n; r >= 0; r--) (n = a[r]) && (s = (o ? n(e, t, s) : n(s)) || s);
        return o && s && os(e, t, s), s;
      };
      let ns = 0;
      const _ = (V = class extends f {
        constructor() {
          super(), this.id = "", this.name = "", this._size = "md", this.fullWidth = false, this._variant = "filled", this.inverted = false, this.label = "", this.ariaLabel = "", this.ariaControls = "", this.prefixIcon = "", this.suffixIcon = "", this.circle = false, this.icon = "", this.disabled = false, this.form = null, this.value = "", this.ariaDescription = "", this._type = "button", this.onClick = () => {
        ...
        set size(e) {
          this._size = V.VALID_SIZES.includes(e) ? e : "md";
        }
        get variant() {
          return this._variant;
        }
        set variant(e) {
          this._variant = V.VALID_VARIANTS.includes(e) ? e : "filled";
        }
        get type() {
          return this._type;
        }
        set type(e) {
          this._type = V.VALID_TYPES.includes(e) ? e : "button";
        }
        get target() {
          return this._target;
        }
        set target(e) {
          this._target = V.VALID_TARGETS.includes(e) ? e : "_self";
        }
        ...
        _handleKeydown(e) {
          if (e.code === "Space" || e.code === "Enter" || e.key === " " || e.key === "Enter") {
            ...
            if (e.preventDefault(), this.href) {
              const t = this.renderRoot.querySelector("a.nys-button");
              t && t.click();
            } else this._handleClick(e);
          }
        }
        focus(e) {
          const t = this.renderRoot.querySelector(this.href ? "a.nys-button" : "button.nys-button");
    ...
    `;
      ...
      }, V.VALID_SIZES = ["sm", "md", "lg"], V.VALID_VARIANTS = ["filled", "outline", "ghost", "text"], V.VALID_TYPES = ["submit", "reset", "button"], V.VALID_TARGETS = ["_self", "_blank", "_parent", "_top", "framename"], V.styles = ss, V.formAssociated = true, V);
      w([i({ type: String })], _.prototype, "id", 2), w([i({ type: String, reflect: true })], _.prototype, "name", 2), w([i({ reflect: true })], _.prototype, "size", 1), w([i({ type: Boolean, reflect: true })], _.prototype, "fullWidth", 2), w([i({ reflect: true })], _.prototype, "variant", 1), w([i({ type: Boolean, reflect: true })], _.prototype, "inverted", 2), w([i({ type: String })], _.prototype, "label", 2), w([i({ type: String })], _.prototype, "ariaLabel", 2), w([i({ type: String })], _.prototype, "ariaControls", 2), w([i({ type: String })], _.prototype, "prefixIcon", 2), w([i({ type: String })], _.prototype, "suffixIcon", 2), w([i({ type: Boolean, reflect: true })], _.prototype, "circle", 2), w([i({ type: String })], _.prototype, "icon", 2), w([i({ type: Boolean, reflect: true })], _.prototype, "disabled", 2), w([i({ type: String, reflect: true })], _.prototype, "form", 2), w([i({ type: String })], _.prototype, "value", 2), w([i({ type: String })], _.prototype, "ariaDescription", 2), w([i({ reflect: true })], _.prototype, "type", 1), w([i({ type: Function })], _.prototype, "onClick", 2), w([i({ type: String })], _.prototype, "href", 2), w([i({ reflect: true })], _.prototype, "target", 1);
      let t1 = _;
      customElements.get("nys-button") || customElements.define("nys-button", t1);
      const is = g`
  :host {
    /* Anything that can be overridden should be defined here */
...
`;
      var as = Object.defineProperty, ls = Object.getOwnPropertyDescriptor, ge = (a, e, t, o) => {
        for (var s = o > 1 ? void 0 : o ? ls(e, t) : e, r = a.length - 1, n; r >= 0; r--) (n = a[r]) && (s = (o ? n(e, t, s) : n(s)) || s);
        return o && s && as(e, t, s), s;
      };
      const se = (N = class extends f {
        constructor() {
        ...
        set size(e) {
          this._size = N.VALID_SIZES.includes(e) ? e : "md";
        }
        get intent() {
          return this._intent;
        }
        set intent(e) {
          this._intent = N.VALID_INTENT.includes(e) ? e : "neutral";
        }
        get prefixIcon() {
          return this._prefixIcon;
        }
        set prefixIcon(e) {
          e === "" || e === null ? this._prefixIcon = true : e === "false" || e === false ? this._prefixIcon = "" : this._prefixIcon = e;
        }
        get suffixIcon() {
          return this._suffixIcon;
        }
        set suffixIcon(e) {
          e === "" || e === null ? this._suffixIcon = true : e === "false" || e === false ? this._suffixIcon = "" : this._suffixIcon = e;
        }
        connectedCallback() {
        ...
        resolveIcon(e) {
          return e === true ? N.DEFAULT_ICONS[this.intent] ?? "info" : typeof e == "string" && e.trim() !== "" ? e : null;
        }
        render() {
    ...
    `;
      ...
      }, N.VALID_SIZES = ["sm", "md"], N.VALID_INTENT = ["neutral", "error", "success", "warning"], N.styles = is, N.DEFAULT_ICONS = { neutral: "info", error: "emergency_home", success: "check_circle", warning: "warning" }, N);
      ge([i({ type: String })], se.prototype, "id", 2), ge([i({ type: String, reflect: true })], se.prototype, "name", 2), ge([i({ reflect: true })], se.prototype, "size", 1), ge([i({ reflect: true })], se.prototype, "intent", 1), ge([i({ type: String })], se.prototype, "prefixLabel", 2), ge([i({ type: String })], se.prototype, "label", 2), ge([i({ type: String, attribute: "prefixicon" })], se.prototype, "prefixIcon", 1), ge([i({ type: String, attribute: "suffixicon" })], se.prototype, "suffixIcon", 1);
      let s1 = se;
      customElements.get("nys-badge") || customElements.define("nys-badge", s1);
      const o1 = g`
  :host {
    /* Anything that can be overridden should be defined here */
...
`;
      var cs = Object.defineProperty, ds = Object.getOwnPropertyDescriptor, q = (a, e, t, o) => {
        for (var s = o > 1 ? void 0 : o ? ds(e, t) : e, r = a.length - 1, n; r >= 0; r--) (n = a[r]) && (s = (o ? n(e, t, s) : n(s)) || s);
        return o && s && cs(e, t, s), s;
      };
      let hs = 0;
      const B = (ae = class extends f {
        constructor() {
          super(), this.id = "", this.name = "", this.required = false, this.optional = false, this.showError = false, this.errorMessage = "", this.label = "", this.description = "", this.tile = false, this._tooltip = "", this.form = null, this._slottedDescriptionText = "", this._size = "md", this._internals = this.attachInternals();
        }
        get size() {
          return this._size;
        }
        set size(e) {
          this._size = ae.VALID_SIZES.includes(e) ? e : "md";
        }
        connectedCallback() {
          super.connectedCallback(), this.id || (this.id = `nys-checkbox-${Date.now()}-${hs++}`), this.addEventListener("nys-change", this._handleCheckboxChange), this.addEventListener("invalid", this._handleInvalid);
        }
        disconnectedCallback() {
        ...
        async _setupCheckboxRequired() {
          ...
          this._internals.setValidity({ valueMissing: true }, t, o || this);
        }
        async _manageRequire() {
          if (this.required) {
            ...
            Array.from(s).some((n) => n.checked) ? (this._internals.setValidity({}), this.showError = false) : (this._internals.setValidity({ valueMissing: true }, e, o || this), this.showError = true);
          }
        }
        _updateCheckboxSize() {
          this.querySelectorAll("nys-checkbox").forEach((t) => {
        ...
        _updateCheckboxTile() {
          this.querySelectorAll("nys-checkbox").forEach((t) => {
            this.tile ? t.toggleAttribute("tile", true) : t.removeAttribute("tile");
          });
        }
        ...
        _getSlotDescriptionForAria() {
          var o;
          const e = (o = this.shadowRoot) == null ? void 0 : o.querySelector('slot[name="description"]'), t = (e == null ? void 0 : e.assignedNodes({ flatten: true })) || [];
        ...
        async _handleInvalid(e) {
          e.preventDefault(), this.showError = true, this._manageRequire();
          ...
          if (o) {
            ...
            s ? Array.from(s.elements).find((d) => {
              if (d.tagName.toLowerCase() === "nys-checkboxgroup") {
                if (Array.from(this.querySelectorAll("nys-checkbox")).filter((p) => p.checked).length === 0) return d;
              } else return typeof d.checkValidity == "function" && !d.checkValidity();
            }) === this && o.focus() : o.focus();
          }
        }
        _handleCheckboxChange(e) {
          const t = e, { name: o } = t.detail, r = Array.from(this.querySelectorAll("nys-checkbox")).filter((n) => n.checked).map((n) => n.value);
    ...
    `;
      ...
      }, ae.VALID_SIZES = ["sm", "md"], ae.styles = o1, ae.formAssociated = true, ae);
      q([i({ type: String })], B.prototype, "id", 2), q([i({ type: String, reflect: true })], B.prototype, "name", 2), q([i({ type: Boolean, reflect: true })], B.prototype, "required", 2), q([i({ type: Boolean, reflect: true })], B.prototype, "optional", 2), q([i({ type: Boolean, reflect: true })], B.prototype, "showError", 2), q([i({ type: String })], B.prototype, "errorMessage", 2), q([i({ type: String })], B.prototype, "label", 2), q([i({ type: String })], B.prototype, "description", 2), q([i({ type: Boolean, reflect: true })], B.prototype, "tile", 2), q([i({ type: String })], B.prototype, "_tooltip", 2), q([i({ type: String, reflect: true })], B.prototype, "form", 2), q([D()], B.prototype, "_slottedDescriptionText", 2), q([i({ reflect: true })], B.prototype, "size", 1);
      let r1 = B;
      customElements.get("nys-checkboxgroup") || customElements.define("nys-checkboxgroup", r1);
      var ys = Object.defineProperty, us = Object.getOwnPropertyDescriptor, P = (a, e, t, o) => {
        for (var s = o > 1 ? void 0 : o ? us(e, t) : e, r = a.length - 1, n; r >= 0; r--) (n = a[r]) && (s = (o ? n(e, t, s) : n(s)) || s);
        return o && s && ys(e, t, s), s;
      };
      let ps = 0;
      const A = (le = class extends f {
        constructor() {
          super(), this.checked = false, this.disabled = false, this.required = false, this.label = "", this.description = "", this.id = "", this.name = "", this.value = "", this.form = null, this.showError = false, this.errorMessage = "", this.groupExist = false, this.tile = false, this._size = "md", this._manageLabelClick = () => {
            var o, s;
        ...
        set size(e) {
          this._size = le.VALID_SIZES.includes(e) ? e : "md";
        }
        ...
        connectedCallback() {
          super.connectedCallback(), this.id || (this.id = `nys-checkbox-${Date.now()}-${ps++}`), this.addEventListener("invalid", this._handleInvalid);
        }
        disconnectedCallback() {
        ...
        _manageRequire() {
          ...
          e && (this.required && !this.checked ? (this._internals.ariaRequired = "true", this._internals.setValidity({ valueMissing: true }, t, e)) : this._internals.setValidity({}));
        }
        _setValidityMessage(e = "") {
          var o, s;
          const t = (o = this.shadowRoot) == null ? void 0 : o.querySelector("input");
          t && (this.showError = !!e, (s = this.errorMessage) != null && s.trim() && e !== "" && (e = this.errorMessage), this._internals.setValidity(e ? { customError: true } : {}, e, t));
        }
        _validate() {
          var s;
        ...
        checkValidity() {
          var t;
          if (this.required && !this.checked) return false;
          const e = (t = this.shadowRoot) == null ? void 0 : t.querySelector("input");
          return e ? e.checkValidity() : true;
        }
        _handleInvalid(e) {
          var o;
          e.preventDefault(), this.showError = true, this._validate();
          const t = (o = this.shadowRoot) == null ? void 0 : o.querySelector("input");
          if (t) {
            const s = this._internals.form;
            s ? Array.from(s.elements).find((d) => typeof d.checkValidity == "function" && !d.checkValidity()) === this && t.focus() : t.focus();
          }
        }
        _emitChangeEvent() {
          this.dispatchEvent(new CustomEvent("nys-change", { detail: { id: this.id, checked: this.checked, name: this.name, value: this.value }, bubbles: true, composed: true }));
        }
        _handleChange(e) {
    ...
    `;
      ...
      }, le.VALID_SIZES = ["sm", "md"], le.styles = o1, le.formAssociated = true, le);
      P([i({ type: Boolean, reflect: true })], A.prototype, "checked", 2), P([i({ type: Boolean, reflect: true })], A.prototype, "disabled", 2), P([i({ type: Boolean, reflect: true })], A.prototype, "required", 2), P([i({ type: String })], A.prototype, "label", 2), P([i({ type: String })], A.prototype, "description", 2), P([i({ type: String })], A.prototype, "id", 2), P([i({ type: String, reflect: true })], A.prototype, "name", 2), P([i({ type: String })], A.prototype, "value", 2), P([i({ type: String, reflect: true })], A.prototype, "form", 2), P([i({ type: Boolean, reflect: true })], A.prototype, "showError", 2), P([i({ type: String })], A.prototype, "errorMessage", 2), P([i({ type: Boolean })], A.prototype, "groupExist", 2), P([i({ type: Boolean, reflect: true })], A.prototype, "tile", 2), P([i({ reflect: true })], A.prototype, "size", 1);
      let n1 = A;
...
`;
      var fs = Object.defineProperty, gs = (a, e, t, o) => {
        for (var s = void 0, r = a.length - 1, n; r >= 0; r--) (n = a[r]) && (s = n(e, t, s) || s);
        return s && fs(e, t, s), s;
      };
      const $t = class $t extends f {
        constructor() {
          super(), this.inverted = false;
        }
        render() {
      ...
      $t.styles = vs;
      let Ye = $t;
      gs([i({ type: Boolean, reflect: true })], Ye.prototype, "inverted"), customElements.get("nys-divider") || customElements.define("nys-divider", Ye);
      const bs = g`
  :host {
...
`;
      var _s = Object.defineProperty, _t = (a, e, t, o) => {
        for (var s = void 0, r = a.length - 1, n; r >= 0; r--) (n = a[r]) && (s = n(e, t, s) || s);
        return s && _s(e, t, s), s;
      };
      const at = class at extends f {
        constructor() {
          super(), this.showError = false, this.errorMessage = "", this.showDivider = false, this._internals = this.attachInternals();
        }
        render() {
      ...
      at.styles = bs, at.formAssociated = true;
      let Ee = at;
      _t([i({ type: Boolean })], Ee.prototype, "showError"), _t([i({ type: String })], Ee.prototype, "errorMessage"), _t([i({ type: Boolean, reflect: true })], Ee.prototype, "showDivider"), customElements.get("nys-errormessage") || customElements.define("nys-errormessage", Ee);
      async function Cs(a, e) {
        ...
        for (const r of t) if (r.startsWith(".") && r.slice(1) === s || r.endsWith("/*") && a.type.startsWith(r.slice(0, -1)) || a.type === r) return true;
        return false;
      }
      const ms = g`
  :host {
...
`;
      var ws = Object.defineProperty, nt = (a, e, t, o) => {
        for (var s = void 0, r = a.length - 1, n; r >= 0; r--) (n = a[r]) && (s = n(e, t, s) || s);
        return s && ws(e, t, s), s;
      };
      const St = class St extends f {
        ...
        _handleRemove() {
          this.dispatchEvent(new CustomEvent("nys-fileRemove", { detail: { filename: this.filename }, bubbles: true, composed: true }));
        }
        splitFilename(e) {
          const t = e.lastIndexOf("."), o = t !== -1 ? e.slice(t) : "", s = t !== -1 ? e.slice(0, t) : e, r = s.slice(0, s.length - 3), n = s.slice(-3);
          return { startPart: r, endPart: n, extension: o };
        }
        render() {
    ...
    `;
      ...
      St.styles = xs;
      let De = St;
      nt([i({ type: String })], De.prototype, "filename"), nt([i({ type: String })], De.prototype, "status"), nt([i({ type: Number })], De.prototype, "progress"), nt([i({ type: String })], De.prototype, "errorMessage"), customElements.define("nys-fileitem", De);
      var ks = Object.defineProperty, M = (a, e, t, o) => {
        for (var s = void 0, r = a.length - 1, n; r >= 0; r--) (n = a[r]) && (s = n(e, t, s) || s);
        return s && ks(e, t, s), s;
      };
      let $s = 0;
      const lt = class lt extends f {
        constructor() {
          super(), this.id = "", this.name = "", this.label = "", this.description = "", this.multiple = false, this.form = null, this._tooltip = "", this.accept = "", this.disabled = false, this.required = false, this.optional = false, this.showError = false, this.errorMessage = "", this.dropzone = false, this.width = "full", this._selectedFiles = [], this._dragActive = false, this._internals = this.attachInternals();
        }
        get _isDropDisabled() {
        ...
        get _buttonAriaDescription() {
          if (this._selectedFiles.length === 0) return `${this.label + " " + this.description}`;
          const e = this._selectedFiles.some((s) => s.status === "error");
          let t = "";
          if (this._selectedFiles.length === 1) t = `You have selected ${this._selectedFiles[0].file.name}.`;
          else {
        ...
        get _innerNysButton() {
          ...
          return (o = e == null ? void 0 : e.shadowRoot) == null ? void 0 : o.querySelector("button");
        }
        connectedCallback() {
          super.connectedCallback(), this.id || (this.id = `nys-fileinput-${Date.now()}-${$s++}`), this.addEventListener("invalid", this._handleInvalid);
        }
        disconnectedCallback() {
          super.disconnectedCallback(), this.removeEventListener("invalid", this._handleInvalid);
        }
        ...
        _manageRequire() {
          ...
          this.required && this._selectedFiles.length == 0 ? (this._internals.ariaRequired = "true", this._internals.setValidity({ valueMissing: true }, t, e)) : (this._internals.ariaRequired = "false", this._internals.setValidity({}, "", e));
        }
        _setValidityMessage(e = "") {
          var o, s;
          const t = (o = this.shadowRoot) == null ? void 0 : o.querySelector("input");
          t && (this.showError = e === (this.errorMessage || "Please upload a file."), (s = this.errorMessage) != null && s.trim() && e !== "" && (e = this.errorMessage), this._internals.setValidity(e ? { customError: true } : {}, e, t));
        }
        _validate() {
          const e = this._selectedFiles.some((s) => s.status === "error"), t = this.required && this._selectedFiles.length === 0;
          let o = "";
        ...
        _handleInvalid(e) {
          ...
          if (t) {
            ...
            o ? Array.from(o.elements).find((n) => typeof n.checkValidity == "function" && !n.checkValidity()) === this && (t.focus(), t.classList.add("active-focus")) : (t.focus(), t.classList.add("active-focus"));
          }
        }
        async _saveSelectedFiles(e) {
          if (this._selectedFiles.some((s) => s.file.name == e.name) || !this.multiple && this._selectedFiles.length >= 1) return;
          const o = { file: e, progress: 0, status: "pending" };
          this._selectedFiles.push(o), await this._processFile(o), this._setValue(), this._validate();
        }
        async _processFile(e) {
          e.status = "processing";
          try {
            if (!await Cs(e.file, this.accept)) {
        ...
        _dispatchChangeEvent() {
          this.dispatchEvent(new CustomEvent("nys-change", { detail: { id: this.id, files: this._selectedFiles }, bubbles: true, composed: true }));
        }
        _openFileDialog() {
          const e = this.renderRoot.querySelector(".hidden-file-input");
          e == null || e.click();
        }
        _handlePostFileSelectionFocus() {
          if (this.multiple) {
            ...
            e && e.focus();
          } else this._focusFirstFileItemIfSingleMode();
        }
        async _focusFirstFileItemIfSingleMode() {
          var e;
          if (!this.multiple) {
            await this.updateComplete;
            const t = this.renderRoot.querySelector("nys-fileitem"), o = (e = t == null ? void 0 : t.shadowRoot) == null ? void 0 : e.querySelector(".file-item");
        ...
        _handleFileRemove(e) {
          ...
          if (this._selectedFiles = this._selectedFiles.filter((s) => s.file.name !== t), this._selectedFiles.length === 0) {
            const s = (o = this.shadowRoot) == null ? void 0 : o.querySelector("input");
            s && (s.value = "");
          }
          this._setValue(), this._validate(), this.requestUpdate(), this._dispatchChangeEvent();
        }
        _onDragOver(e) {
          this.disabled || (e.stopPropagation(), e.preventDefault(), this._dragActive || (this._dragActive = true, this.requestUpdate()));
        }
        _onDragLeave(e) {
          this.disabled || (e.stopPropagation(), e.preventDefault(), e.currentTarget === e.target && (this._dragActive = false, this.requestUpdate()));
        }
        _onDrop(e) {
          var s;
          if (this.disabled) return;
          e.preventDefault(), this._dragActive = false, this.requestUpdate();
    ...
    >
      ...
      lt.styles = ms, lt.formAssociated = true;
      let $ = lt;
      M([i({ type: String })], $.prototype, "id"), M([i({ type: String, reflect: true })], $.prototype, "name"), M([i({ type: String })], $.prototype, "label"), M([i({ type: String })], $.prototype, "description"), M([i({ type: Boolean })], $.prototype, "multiple"), M([i({ type: String, reflect: true })], $.prototype, "form"), M([i({ type: String })], $.prototype, "_tooltip"), M([i({ type: String })], $.prototype, "accept"), M([i({ type: Boolean, reflect: true })], $.prototype, "disabled"), M([i({ type: Boolean, reflect: true })], $.prototype, "required"), M([i({ type: Boolean, reflect: true })], $.prototype, "optional"), M([i({ type: Boolean, reflect: true })], $.prototype, "showError"), M([i({ type: String })], $.prototype, "errorMessage"), M([i({ type: Boolean })], $.prototype, "dropzone"), M([i({ type: String, reflect: true })], $.prototype, "width"), customElements.get("nys-fileinput") || customElements.define("nys-fileinput", $);
      const Ss = { account_circle: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
...
`;
      var Es = Object.defineProperty, Ds = Object.getOwnPropertyDescriptor, Pe = (a, e, t, o) => {
        for (var s = o > 1 ? void 0 : o ? Ds(e, t) : e, r = a.length - 1, n; r >= 0; r--) (n = a[r]) && (s = (o ? n(e, t, s) : n(s)) || s);
        return o && s && Es(e, t, s), s;
      };
      const Ae = (me = class extends f {
        constructor() {
        ...
        set size(e) {
          this._size = me.VALID_TYPES.includes(e) ? e : "sm";
        }
        getIcon() {
          const e = Ss[this.name];
          if (!e) return null;
      ...
      }, me.styles = Ls, me.VALID_TYPES = ["2xs", "xs", "sm", "md", "lg", "xl", "2xl", "3xl", "4xl", "12", "16", "24", "32", "40", "48", "64"], me);
      Pe([i({ type: String, reflect: true })], Ae.prototype, "name", 2), Pe([i({ type: String })], Ae.prototype, "ariaLabel", 2), Pe([i({ type: String })], Ae.prototype, "rotate", 2), Pe([i({ type: String })], Ae.prototype, "flip", 2), Pe([i({ type: String })], Ae.prototype, "color", 2), Pe([i({ reflect: true })], Ae.prototype, "size", 1);
      let i1 = Ae;
      customElements.get("nys-icon") || customElements.define("nys-icon", i1);
      const As = g`
  :host {
    /* Label Typography */
...
`;
      var Ms = Object.defineProperty, zs = Object.getOwnPropertyDescriptor, Ze = (a, e, t, o) => {
        for (var s = o > 1 ? void 0 : o ? zs(e, t) : e, r = a.length - 1, n; r >= 0; r--) (n = a[r]) && (s = (o ? n(e, t, s) : n(s)) || s);
        return o && s && Ms(e, t, s), s;
      };
      const Lt = class Lt extends f {
        constructor() {
          super(...arguments), this.for = "", this.label = "", this.description = "", this.flag = "", this.tooltipInverted = false, this._tooltip = "";
        }
        get tooltip() {
    ...
    `;
      ...
      Lt.styles = As;
      let Q = Lt;
      Ze([i({ type: String })], Q.prototype, "for", 2), Ze([i({ type: String })], Q.prototype, "label", 2), Ze([i({ type: String })], Q.prototype, "description", 2), Ze([i({ type: String })], Q.prototype, "flag", 2), Ze([i({ type: Boolean, reflect: true })], Q.prototype, "tooltipInverted", 2), Ze([i({ type: String })], Q.prototype, "tooltip", 1), customElements.get("nys-label") || customElements.define("nys-label", Q);
      const Vs = g`
  :host {
    /* Global Modal Styles */
...
`;
      var Hs = Object.defineProperty, Is = Object.getOwnPropertyDescriptor, be = (a, e, t, o) => {
        for (var s = o > 1 ? void 0 : o ? Is(e, t) : e, r = a.length - 1, n; r >= 0; r--) (n = a[r]) && (s = (o ? n(e, t, s) : n(s)) || s);
        return o && s && Hs(e, t, s), s;
      };
      let Bs = 0;
      const oe = (xe = class extends f {
        constructor() {
          super(), this.id = "", this.heading = "", this.subheading = "", this.open = false, this.mandatory = false, this._width = "md", this._actionButtonSlot = null, this._prevFocusedElement = null, this._originalBodyOverflow = null, this.hasBodySlots = false, this.hasActionSlots = false;
        }
        get width() {
          return this._width;
        }
        set width(e) {
          this._width = xe.VALID_WIDTHS.includes(e) ? e : "md";
        }
        connectedCallback() {
          super.connectedCallback(), this.id || (this.id = `nys-{{componentName}}-${Date.now()}-${Bs++}`), window.addEventListener("resize", () => this._updateSlottedButtonWidth()), window.addEventListener("keydown", (e) => this._handleKeydown(e));
        }
        disconnectedCallback() {
        ...
        async _restorePrevFocused() {
          ...
          } else (t = this._prevFocusedElement) == null || t.focus();
          this._prevFocusedElement = null;
        }
        async _handleBodySlotChange() {
          var t;
          const e = (t = this.shadowRoot) == null ? void 0 : t.querySelector("slot");
          e && (this.hasBodySlots = e.assignedNodes({ flatten: true }).some((o) => {
            var s;
        ...
        async _handleActionSlotChange() {
          var t;
          const e = (t = this.shadowRoot) == null ? void 0 : t.querySelector('slot[name="actions"]');
          e && (this.hasActionSlots = e.assignedNodes({ flatten: true }).some((o) => {
            var s;
            return o.nodeType === Node.ELEMENT_NODE || ((s = o.textContent) == null ? void 0 : s.trim());
        ...
        _dispatchOpenEvent() {
          this.dispatchEvent(new CustomEvent("nys-open", { detail: { id: this.id }, bubbles: true, composed: true }));
        }
        _dispatchCloseEvent() {
          this.dispatchEvent(new CustomEvent("nys-close", { detail: { id: this.id }, bubbles: true, composed: true }));
        }
        _getAriaDescribedBy() {
          const e = [];
        ...
        async _handleKeydown(e) {
          ...
          if (this.open && (e.key === "Escape" && !this.mandatory && (e.preventDefault(), this._closeModal()), e.key === "Tab")) {
            ...
            if (!o) return;
            const s = 'a[href], area[href], button:not([disabled]), details, iframe, object, input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [contentEditable="true"], [tabindex]:not([tabindex^="-"])', r = [], n = o.querySelector("nys-button");
            n && r.push(n);
            const d = Array.from(o.querySelectorAll("slot"));
            for (const c of d) {
              const y = c.assignedElements({ flatten: true });
              for (const p of y) p instanceof HTMLElement && p.matches(s) && r.push(p), p.querySelectorAll("nys-button").forEach((h) => {
                r.push(h);
              });
            }
            if (r.length > 0) {
              const c = r[0], y = r[r.length - 1];
              let p = document.activeElement, h = r.indexOf(p);
              if (e.shiftKey) {
                e.preventDefault();
                let x = h - 1;
                x < 0 && (x = r.length - 1);
                const E = r[x];
                if (r[x].tagName.toLowerCase() === "nys-button") {
                  const we = await E.getButtonElement();
                  we == null || we.focus();
                } else E.focus();
              } else if (p === y) if (e.preventDefault(), c.tagName.toLowerCase() === "nys-button") {
                const x = await c.getButtonElement();
                x == null || x.focus();
              } else c.focus();
            }
          }
      ...
      }, xe.VALID_WIDTHS = ["sm", "md", "lg"], xe.styles = Vs, xe);
      be([i({ type: String })], oe.prototype, "id", 2), be([i({ type: String })], oe.prototype, "heading", 2), be([i({ type: String })], oe.prototype, "subheading", 2), be([i({ type: Boolean, reflect: true })], oe.prototype, "open", 2), be([i({ type: Boolean, reflect: true })], oe.prototype, "mandatory", 2), be([i({ reflect: true })], oe.prototype, "width", 1), be([D()], oe.prototype, "hasBodySlots", 2), be([D()], oe.prototype, "hasActionSlots", 2);
      let a1 = oe;
      customElements.get("nys-modal") || customElements.define("nys-modal", a1);
      const Ps = g`
  :host {
    /* Anything that can be overridden should be defined here */
...
`;
      var Zs = Object.defineProperty, Ke = (a, e, t, o) => {
        for (var s = void 0, r = a.length - 1, n; r >= 0; r--) (n = a[r]) && (s = n(e, t, s) || s);
        return s && Zs(e, t, s), s;
      };
      let Os = 0;
      const Et = class Et extends f {
        constructor() {
          super(), this.id = "", this.name = "", this.currentPage = 1, this.totalPages = 1, this._twoBeforeLast = false;
        }
        updated(e) {
          super.updated(e), this.currentPage = this._clampPage(this.currentPage), this._twoBeforeLast = this.currentPage === this.totalPages - 2;
        }
        connectedCallback() {
          super.connectedCallback(), this.id || (this.id = `nys-pagination-${Date.now()}-${Os++}`);
        }
        _clampPage(e) {
      ...
      `);
          ...
          id=${c}
        ></nys-button>`);
          }, r = this.totalPages, n = this.currentPage - 1, d = this.currentPage + 1;
          return t(1), this.currentPage > 2 && o("first-spacer"), n > 1 && t(n, "prev-page"), this.currentPage !== 1 && this.currentPage !== r && t(this.currentPage, "current-page"), d < r && t(d, "next-page"), this.currentPage < r - 1 && o("last-spacer"), r > 1 && t(r), e;
        }
        _handlePageClick(e) {
          this.currentPage = this._clampPage(e), this.dispatchEvent(new CustomEvent("nys-change", { detail: { page: this.currentPage }, bubbles: true, composed: true }));
        }
        render() {
      ...
      Et.styles = Ps;
      let re = Et;
      Ke([i({ type: String })], re.prototype, "id"), Ke([i({ type: String, reflect: true })], re.prototype, "name"), Ke([i({ type: Number, reflect: true })], re.prototype, "currentPage"), Ke([i({ type: Number, reflect: true })], re.prototype, "totalPages"), Ke([i({ type: Boolean, reflect: true })], re.prototype, "_twoBeforeLast"), customElements.get("nys-pagination") || customElements.define("nys-pagination", re);
      const l1 = g`
  :host {
...
`;
      var Us = Object.defineProperty, qs = Object.getOwnPropertyDescriptor, Z = (a, e, t, o) => {
        for (var s = o > 1 ? void 0 : o ? qs(e, t) : e, r = a.length - 1, n; r >= 0; r--) (n = a[r]) && (s = (o ? n(e, t, s) : n(s)) || s);
        return o && s && Us(e, t, s), s;
      };
      let Ts = 0;
      const z = (ce = class extends f {
        constructor() {
          super(), this.id = "", this.name = "", this.required = false, this.optional = false, this.showError = false, this.errorMessage = "", this.label = "", this.description = "", this.tile = false, this._tooltip = "", this.form = null, this.selectedValue = null, this._slottedDescriptionText = "", this._size = "md", this._internals = this.attachInternals();
        }
        get size() {
          return this._size;
        }
        set size(e) {
          this._size = ce.VALID_SIZES.includes(e) ? e : "md";
        }
        connectedCallback() {
          super.connectedCallback(), this.id || (this.id = `nys-radiogroup-${Date.now()}-${Ts++}`), this.addEventListener("nys-change", this._handleRadioButtonChange), this.addEventListener("invalid", this._handleInvalid);
        }
        disconnectedCallback() {
        ...
        async _manageRequire() {
          ...
          o && (this.required && !this.selectedValue ? this._internals.setValidity({ valueMissing: true }, e, o) : (this.showError = false, this._internals.setValidity({}, "", o)));
        }
        checkValidity() {
        ...
        async _handleKeyDown(e) {
          ...
          e.preventDefault();
          const o = this._getAllRadios().filter((y) => !y.disabled), s = o.find((y) => y.checked) || o[0], r = e.key === " " || e.key === "Enter" ? 0 : ["ArrowUp", "ArrowLeft"].includes(e.key) ? -1 : 1;
          let n = o.indexOf(s) + r;
          n < 0 && (n = o.length - 1), n >= o.length && (n = 0);
          const d = o[n], c = await d.getInputElement();
          c == null || c.click(), this._updateGroupTabIndex(), d.focus();
        }
        ...
        async _handleInvalid(e) {
          if (e.preventDefault(), this._internals.validity.valueMissing) {
            this.showError = true, this._manageRequire();
      ...
      }, ce.VALID_SIZES = ["sm", "md"], ce.styles = l1, ce.formAssociated = true, ce);
      Z([i({ type: String })], z.prototype, "id", 2), Z([i({ type: String, reflect: true })], z.prototype, "name", 2), Z([i({ type: Boolean, reflect: true })], z.prototype, "required", 2), Z([i({ type: Boolean, reflect: true })], z.prototype, "optional", 2), Z([i({ type: Boolean, reflect: true })], z.prototype, "showError", 2), Z([i({ type: String })], z.prototype, "errorMessage", 2), Z([i({ type: String })], z.prototype, "label", 2), Z([i({ type: String })], z.prototype, "description", 2), Z([i({ type: Boolean, reflect: true })], z.prototype, "tile", 2), Z([i({ type: String })], z.prototype, "_tooltip", 2), Z([i({ type: String, reflect: true })], z.prototype, "form", 2), Z([D()], z.prototype, "selectedValue", 2), Z([D()], z.prototype, "_slottedDescriptionText", 2), Z([i({ reflect: true })], z.prototype, "size", 1);
      let c1 = z;
      customElements.get("nys-radiogroup") || customElements.define("nys-radiogroup", c1);
      var Rs = Object.defineProperty, Ns = Object.getOwnPropertyDescriptor, F = (a, e, t, o) => {
        for (var s = o > 1 ? void 0 : o ? Ns(e, t) : e, r = a.length - 1, n; r >= 0; r--) (n = a[r]) && (s = (o ? n(e, t, s) : n(s)) || s);
        return o && s && Rs(e, t, s), s;
      };
      let Fs = 0;
      const R = (m = class extends f {
        constructor() {
          super(...arguments), this.checked = false, this.disabled = false, this.required = false, this.label = "", this.description = "", this.id = "", this.name = "", this.value = "", this.form = null, this._size = "md", this.tile = false;
        }
        get size() {
          return this._size;
        }
        set size(e) {
          this._size = m.VALID_SIZES.includes(e) ? e : "md";
        }
        async getInputElement() {
          var e;
          return await this.updateComplete, ((e = this.shadowRoot) == null ? void 0 : e.querySelector("input")) || null;
        ...
        connectedCallback() {
          super.connectedCallback(), this.id || (this.id = `nys-radiobutton-${Date.now()}-${Fs++}`), this.checked && (m.buttonGroup[this.name] && (m.buttonGroup[this.name].checked = false, m.buttonGroup[this.name].requestUpdate()), m.buttonGroup[this.name] = this), this.addEventListener("focus", this._handleFocus), this.addEventListener("blur", this._handleBlur), this.addEventListener("click", this._handleChange);
        }
        disconnectedCallback() {
        ...
        updated(e) {
          e.has("checked") && this.checked && m.buttonGroup[this.name] !== this && (m.buttonGroup[this.name] && (m.buttonGroup[this.name].checked = false, m.buttonGroup[this.name].requestUpdate()), m.buttonGroup[this.name] = this);
        }
        checkValidity() {
          var t;
          if (this.required && !this.checked) return false;
        ...
        _handleChange() {
          this.classList.remove("active-focus"), !this.checked && !this.disabled && (m.buttonGroup[this.name] && (m.buttonGroup[this.name].checked = false, m.buttonGroup[this.name].requestUpdate()), m.buttonGroup[this.name] = this, this.checked = true, this._emitChangeEvent());
        }
        _handleFocus() {
          this.dispatchEvent(new Event("nys-focus"));
        }
        ...
        _callInputHandling() {
          var t;
          if (this.disabled) return;
          const e = (t = this.shadowRoot) == null ? void 0 : t.querySelector('input[type="radio"]');
          e && (e.focus(), e.click());
        }
        render() {
          return l`
    ...
    `;
      ...
      }, m.VALID_SIZES = ["sm", "md"], m.buttonGroup = {}, m.styles = l1, m);
      F([i({ type: Boolean, reflect: true })], R.prototype, "checked", 2), F([i({ type: Boolean, reflect: true })], R.prototype, "disabled", 2), F([i({ type: Boolean, reflect: true })], R.prototype, "required", 2), F([i({ type: String })], R.prototype, "label", 2), F([i({ type: String })], R.prototype, "description", 2), F([i({ type: String })], R.prototype, "id", 2), F([i({ type: String, reflect: true })], R.prototype, "name", 2), F([i({ type: String })], R.prototype, "value", 2), F([i({ type: String, reflect: true })], R.prototype, "form", 2), F([i({ reflect: true })], R.prototype, "size", 1), F([i({ type: Boolean, reflect: true })], R.prototype, "tile", 2);
      let d1 = R;
      customElements.get("nys-radiobutton") || customElements.define("nys-radiobutton", d1);
      const js = g`
  :host {
...
`;
      var Gs = Object.defineProperty, Xe = (a, e, t, o) => {
        for (var s = void 0, r = a.length - 1, n; r >= 0; r--) (n = a[r]) && (s = n(e, t, s) || s);
        return s && Gs(e, t, s), s;
      };
      class _e extends f {
    ...
    `;
      ...
      Xe([i({ type: Boolean, reflect: true })], _e.prototype, "disabled"), Xe([i({ type: Boolean, reflect: true })], _e.prototype, "selected"), Xe([i({ type: String })], _e.prototype, "value"), Xe([i({ type: String })], _e.prototype, "label"), Xe([i({ type: Boolean, reflect: true })], _e.prototype, "hidden"), customElements.define("nys-option", _e);
      var Ws = Object.defineProperty, Ys = Object.getOwnPropertyDescriptor, T = (a, e, t, o) => {
        for (var s = o > 1 ? void 0 : o ? Ys(e, t) : e, r = a.length - 1, n; r >= 0; r--) (n = a[r]) && (s = (o ? n(e, t, s) : n(s)) || s);
        return o && s && Ws(e, t, s), s;
      };
      let Ks = 0;
      const O = (de = class extends f {
        constructor() {
          super(), this.id = "", this.name = "", this.label = "", this.description = "", this.value = "", this.disabled = false, this.required = false, this.optional = false, this._tooltip = "", this.form = null, this.showError = false, this.errorMessage = "", this._width = "md", this._hasUserInteracted = false, this._internals = this.attachInternals();
        }
        get width() {
          return this._width;
        }
        set width(e) {
          this._width = de.VALID_WIDTHS.includes(e) ? e : "full";
        }
        connectedCallback() {
          super.connectedCallback(), this.id || (this.id = `nys-select-${Date.now()}-${Ks++}`), this.addEventListener("invalid", this._handleInvalid);
        }
        disconnectedCallback() {
          super.disconnectedCallback(), this.removeEventListener("invalid", this._handleInvalid);
        }
        ...
        _handleSlotChange() {
          var s, r;
          const e = (s = this.shadowRoot) == null ? void 0 : s.querySelector('slot:not([name="description"])'), t = (r = this.shadowRoot) == null ? void 0 : r.querySelector("select");
          if (!e || !t) return;
          t.querySelectorAll("option:not([hidden])").forEach((n) => n.remove()), e.assignedElements({ flatten: true }).forEach((n) => {
            var d;
            if (n instanceof _e) {
              const c = document.createElement("option");
              c.value = n.value, c.textContent = n.label || ((d = n.textContent) == null ? void 0 : d.trim()) || "", c.disabled = n.disabled, c.selected = n.selected, t.appendChild(c);
            }
          });
        }
        _setValue() {
        ...
        _manageRequire() {
          ...
          this.required && !this.value ? (this._internals.ariaRequired = "true", this._internals.setValidity({ valueMissing: true }, t, e)) : (this._internals.ariaRequired = "false", this._internals.setValidity({}), this._hasUserInteracted = false);
        }
        _setValidityMessage(e = "") {
          var o, s;
        ...
        _handleInvalid(e) {
          var o;
          e.preventDefault(), this._hasUserInteracted = true, this._validate(), this.showError = true;
          const t = (o = this.shadowRoot) == null ? void 0 : o.querySelector("select");
          if (t) {
            const s = this._internals.form;
            s ? Array.from(s.elements).find((d) => typeof d.checkValidity == "function" && !d.checkValidity()) === this && t.focus() : t.focus();
        ...
        _handleChange(e) {
          const t = e.target;
          this.value = t.value, this._internals.setFormValue(this.value), this._hasUserInteracted && this._validate(), this.dispatchEvent(new CustomEvent("nys-change", { detail: { id: this.id, value: this.value }, bubbles: true, composed: true }));
        }
        _handleFocus() {
          this.dispatchEvent(new Event("nys-focus"));
        }
        _handleBlur() {
          this._hasUserInteracted || (this._hasUserInteracted = true), this._validate(), this.dispatchEvent(new Event("nys-blur"));
        }
        updated(e) {
          var t;
    ...
    `;
      ...
      }, de.VALID_WIDTHS = ["sm", "md", "lg", "full"], de.styles = js, de.formAssociated = true, de);
      T([i({ type: String })], O.prototype, "id", 2), T([i({ type: String, reflect: true })], O.prototype, "name", 2), T([i({ type: String })], O.prototype, "label", 2), T([i({ type: String })], O.prototype, "description", 2), T([i({ type: String })], O.prototype, "value", 2), T([i({ type: Boolean, reflect: true })], O.prototype, "disabled", 2), T([i({ type: Boolean, reflect: true })], O.prototype, "required", 2), T([i({ type: Boolean, reflect: true })], O.prototype, "optional", 2), T([i({ type: String })], O.prototype, "_tooltip", 2), T([i({ type: String, reflect: true })], O.prototype, "form", 2), T([i({ type: Boolean, reflect: true })], O.prototype, "showError", 2), T([i({ type: String })], O.prototype, "errorMessage", 2), T([i({ reflect: true })], O.prototype, "width", 1);
      let h1 = O;
      customElements.get("nys-select") || customElements.define("nys-select", h1);
      const Xs = g`
  :host {
...
`;
      var Qs = Object.defineProperty, y1 = (a, e, t, o) => {
        for (var s = void 0, r = a.length - 1, n; r >= 0; r--) (n = a[r]) && (s = n(e, t, s) || s);
        return s && Qs(e, t, s), s;
      };
    ...
    `;
      ...
      Dt.styles = Xs;
      let Oe = Dt;
      y1([i({ type: String })], Oe.prototype, "id"), y1([i({ type: String })], Oe.prototype, "href"), customElements.get("nys-skipnav") || customElements.define("nys-skipnav", Oe);
      const u1 = g`
  :host {
    /* Anything that can be overridden should be defined here */
...
`;
      var Js = Object.defineProperty, Me = (a, e, t, o) => {
        for (var s = void 0, r = a.length - 1, n; r >= 0; r--) (n = a[r]) && (s = n(e, t, s) || s);
        return s && Js(e, t, s), s;
      };
      const At = class At extends f {
        constructor() {
          super(...arguments), this.selected = false, this.current = false, this.label = "", this.href = "", this.isCompactExpanded = false, this.stepNumber = 0;
        }
        _handleActivate(e) {
          typeof this.onClick == "function" && this.onClick(e);
          const t = new CustomEvent("nys-step-click", { bubbles: true, composed: true, cancelable: true, detail: { href: this.href, label: this.label } });
    ...
    `;
      ...
      At.styles = u1;
      let j = At;
      Me([i({ type: Boolean, reflect: true })], j.prototype, "selected"), Me([i({ type: Boolean, reflect: true })], j.prototype, "current"), Me([i({ type: String })], j.prototype, "label"), Me([i({ type: String })], j.prototype, "href"), Me([i({ type: Boolean })], j.prototype, "isCompactExpanded"), Me([i({ type: Function })], j.prototype, "onClick"), Me([i({ type: Number })], j.prototype, "stepNumber"), customElements.get("nys-step") || customElements.define("nys-step", j);
      var eo = Object.defineProperty, Qe = (a, e, t, o) => {
        for (var s = void 0, r = a.length - 1, n; r >= 0; r--) (n = a[r]) && (s = n(e, t, s) || s);
        return s && eo(e, t, s), s;
      };
      const Mt = class Mt extends f {
        constructor() {
          super(), this.id = "", this.name = "", this.label = "", this.counterText = "initial", this.isCompactExpanded = false, this._stepsNumbered = false, this._onStepClick = async (e) => {
            const t = e.composedPath().find((n) => n instanceof HTMLElement && n.tagName.toLowerCase() === "nys-step");
            if (!t) return;
            const o = Array.from(this.querySelectorAll("nys-step")), s = o.findIndex((n) => n.hasAttribute("current")), r = o.indexOf(t);
            s !== -1 && r > s || t.hasAttribute("selected") || (o.forEach((n) => n.removeAttribute("selected")), t.setAttribute("selected", ""), this._updateCounter(), this.isCompactExpanded = false);
          };
        }
        connectedCallback() {
        ...
        _validateSteps() {
          Array.from(this.children).forEach((e) => {
            ...
            !t && !o && (console.warn("Only <nys-step> elements or the <div slot='actions'> container are allowed as direct children of <nys-stepper>. Removing:", e), e.remove());
          });
        }
        _validateButtonSlot(e) {
          const o = e.target.assignedElements();
          if (o.length !== 1 || o[0].tagName.toLowerCase() !== "div") {
            console.warn("The 'actions' slot must have exactly one <div> as a direct child.");
            return;
          }
          const s = o[0];
          Array.from(s.children).forEach((r) => {
            r instanceof HTMLElement && r.tagName.toLowerCase() === "nys-button" ? (r.setAttribute("size", "sm"), r.hasAttribute("fullWidth") && (r.style.flex = "1 1 0")) : (console.warn("The <div> inside 'actions' slot only accepts <nys-button> elements. Removing invalid node:", r), r.remove());
          });
        }
        _updateCounter() {
          ...
          const e = this.querySelectorAll("nys-step"), t = Array.from(e).findIndex((s) => s.hasAttribute("selected")), o = e.length;
          this.counterText = t >= 0 ? `Step ${t + 1} of ${o}` : `Step 1 of ${o}`;
        }
        updated() {
          const e = this.querySelectorAll("nys-step");
          this._stepsNumbered || (e.forEach((r, n) => {
            r.stepNumber = n + 1;
          }), this._stepsNumbered = true);
          let t = false, o = false, s = false;
          e.forEach((r, n) => {
            r.hasAttribute("current") && (s ? r.removeAttribute("current") : s = true), n === 0 ? r.setAttribute("first", "") : r.removeAttribute("first"), r.hasAttribute("current") ? (t = true, r.removeAttribute("previous")) : t ? r.removeAttribute("previous") : r.setAttribute("previous", ""), r.hasAttribute("selected") && (t || o ? r.removeAttribute("selected") : o = true), this.hasAttribute("isCompactExpanded") ? r.setAttribute("isCompactExpanded", "") : r.removeAttribute("isCompactExpanded");
          }), o || (s ? e.forEach((r) => {
            r.hasAttribute("current") && !o && (r.setAttribute("selected", ""), o = true);
    ...
    `;
      ...
      Mt.styles = u1;
      let ne = Mt;
      Qe([i({ type: String })], ne.prototype, "id"), Qe([i({ type: String, reflect: true })], ne.prototype, "name"), Qe([i({ type: String })], ne.prototype, "label"), Qe([i({ type: String })], ne.prototype, "counterText"), Qe([i({ type: Boolean, reflect: true })], ne.prototype, "isCompactExpanded"), customElements.get("nys-stepper") || customElements.define("nys-stepper", ne);
      const to = g`
  :host {
    /* Anything that can be overridden should be defined here */
...
`;
      var so = Object.defineProperty, oo = Object.getOwnPropertyDescriptor, L = (a, e, t, o) => {
        for (var s = o > 1 ? void 0 : o ? oo(e, t) : e, r = a.length - 1, n; r >= 0; r--) (n = a[r]) && (s = (o ? n(e, t, s) : n(s)) || s);
        return o && s && so(e, t, s), s;
      };
      let ro = 0;
      const S = (Y = class extends f {
        constructor() {
          super(), this.id = "", this.name = "", this.label = "", this.description = "", this.placeholder = "", this.value = "", this.disabled = false, this.readonly = false, this.required = false, this.optional = false, this._tooltip = "", this.form = null, this.maxlength = null, this.width = "full", this.rows = 4, this._resize = "vertical", this.showError = false, this.errorMessage = "", this._hasUserInteracted = false, this._internals = this.attachInternals();
        }
        get resize() {
          return this._resize;
        }
        set resize(e) {
          this._resize = Y.VALID_RESIZE.includes(e) ? e : "vertical";
        }
        async updated(e) {
          await Promise.resolve(), e.has("width") && (this.width = Y.VALID_WIDTHS.includes(this.width) ? this.width : "full"), e.has("rows") && (this.rows = this.rows ?? 4);
        }
        connectedCallback() {
          super.connectedCallback(), this.id || (this.id = `nys-textarea-${Date.now()}-${ro++}`), this.addEventListener("invalid", this._handleInvalid);
        }
        disconnectedCallback() {
          super.disconnectedCallback(), this.removeEventListener("invalid", this._handleInvalid);
        }
        ...
        _handleInvalid(e) {
          var o;
          e.preventDefault(), this._hasUserInteracted = true, this._validate();
          const t = (o = this.shadowRoot) == null ? void 0 : o.querySelector("textarea");
          if (t) {
            const s = this._internals.form;
            s ? Array.from(s.elements).find((d) => typeof d.checkValidity == "function" && !d.checkValidity()) === this && t.focus() : t.focus();
        ...
        _handleInput(e) {
          const t = e.target;
          this.value = t.value, this._internals.setFormValue(this.value), this._hasUserInteracted && this._validate(), this.dispatchEvent(new CustomEvent("nys-input", { detail: { id: this.id, value: this.value }, bubbles: true, composed: true }));
        }
        _handleFocus() {
          this.dispatchEvent(new Event("nys-focus"));
        }
        ...
        _handleSelect(e) {
          const t = e.target;
          this.value = t.value, this.dispatchEvent(new CustomEvent("nys-select", { detail: { value: this.value }, bubbles: true, composed: true }));
        }
        _handleSelectionChange(e) {
          const t = e.target;
          this.value = t.value, this.dispatchEvent(new CustomEvent("nys-selectionchange", { detail: { id: this.id, value: this.value }, bubbles: true, composed: true }));
        }
        render() {
          return l`
...
${this.value}</textarea
    ...
    `;
      ...
      }, Y.VALID_WIDTHS = ["sm", "md", "lg", "full"], Y.VALID_RESIZE = ["vertical", "none"], Y.styles = to, Y.formAssociated = true, Y);
      L([i({ type: String })], S.prototype, "id", 2), L([i({ type: String, reflect: true })], S.prototype, "name", 2), L([i({ type: String })], S.prototype, "label", 2), L([i({ type: String })], S.prototype, "description", 2), L([i({ type: String })], S.prototype, "placeholder", 2), L([i({ type: String })], S.prototype, "value", 2), L([i({ type: Boolean, reflect: true })], S.prototype, "disabled", 2), L([i({ type: Boolean, reflect: true })], S.prototype, "readonly", 2), L([i({ type: Boolean, reflect: true })], S.prototype, "required", 2), L([i({ type: Boolean, reflect: true })], S.prototype, "optional", 2), L([i({ type: String })], S.prototype, "_tooltip", 2), L([i({ type: String, reflect: true })], S.prototype, "form", 2), L([i({ type: Number })], S.prototype, "maxlength", 2), L([i({ reflect: true })], S.prototype, "width", 2), L([i({ type: Number })], S.prototype, "rows", 2), L([i({ reflect: true })], S.prototype, "resize", 1), L([i({ type: Boolean, reflect: true })], S.prototype, "showError", 2), L([i({ type: String })], S.prototype, "errorMessage", 2);
      let p1 = S;
      customElements.get("nys-textarea") || customElements.define("nys-textarea", p1);
      const no = g`
  :host {
    /* Anything that can be overridden should be defined here */
...
`;
      var io = Object.defineProperty, ao = Object.getOwnPropertyDescriptor, C = (a, e, t, o) => {
        for (var s = o > 1 ? void 0 : o ? ao(e, t) : e, r = a.length - 1, n; r >= 0; r--) (n = a[r]) && (s = (o ? n(e, t, s) : n(s)) || s);
        return o && s && io(e, t, s), s;
      };
      let lo = 0;
      const b = (K = class extends f {
        constructor() {
          super(), this.id = "", this.name = "", this._type = "text", this.label = "", this.description = "", this.placeholder = "", this.value = "", this.disabled = false, this.readonly = false, this.required = false, this.optional = false, this._tooltip = "", this.form = null, this.pattern = "", this.maxlength = null, this.width = "full", this.step = null, this.min = null, this.max = null, this.showError = false, this.errorMessage = "", this.showPassword = false, this._originalErrorMessage = "", this._hasUserInteracted = false, this._maskPatterns = { tel: "(___) ___-____" }, this._internals = this.attachInternals();
        }
        get type() {
          return this._type;
        }
        set type(e) {
          this._type = K.VALID_TYPES.includes(e) ? e : "text";
        }
        connectedCallback() {
          super.connectedCallback(), this.id || (this.id = `nys-textinput-${Date.now()}-${lo++}`), this._originalErrorMessage = this.errorMessage ?? "", this.addEventListener("invalid", this._handleInvalid);
        }
        disconnectedCallback() {
          super.disconnectedCallback(), this.removeEventListener("invalid", this._handleInvalid);
        }
        ...
        async updated(e) {
          var t, o;
          if (e.has("width") && (await Promise.resolve(), this.width = K.VALID_WIDTHS.includes(this.width) ? this.width : "full"), e.has("disabled") && (this._validateButtonSlot("startButton"), this._validateButtonSlot("endButton")), e.has("type")) {
            const s = this._maskPatterns[this.type], r = (t = this.shadowRoot) == null ? void 0 : t.querySelector("input");
            if (r) if (s) r.maxLength = s.length, this._updateOverlay(r.value, s);
            else {
              r.removeAttribute("maxLength");
              const n = (o = this.shadowRoot) == null ? void 0 : o.querySelector(".nys-textinput__mask-overlay");
              n && (n.textContent = "");
            }
          }
        }
        ...
        _manageRequire() {
          ...
          if (!e) return;
          const t = this.errorMessage || "This field is required";
          this.required && (!this.value || ((r = this.value) == null ? void 0 : r.trim()) === "") ? (this._internals.ariaRequired = "true", this._internals.setValidity({ valueMissing: true }, t, e)) : (this._internals.ariaRequired = "false", this._internals.setValidity({}), this._hasUserInteracted = false);
        }
        _setValidityMessage(e = "") {
          var s, r;
        ...
        _updateOverlay(e, t) {
          var n;
          const o = (n = this.shadowRoot) == null ? void 0 : n.querySelector(".nys-textinput__mask-overlay");
          if (!o) return;
        ...
        _applyMask(e, t) {
          ...
          let s = "";
          if (this.type === "tel") return o.length > 0 && (s = "(" + o.substring(0, 3)), o.length >= 4 && (s += ") " + o.substring(3, 6)), o.length > 6 && (s += "-" + o.substring(6, 10)), s;
          let r = 0;
          for (let n = 0; n < t.length; n++) if (t[n] === "_" || t[n].match(/[d9]/i)) if (r < o.length) s += o[r++];
          else break;
          else s += t[n];
          return s;
        }
        _handleInput(e) {
          ...
          s && (o = this._applyMask(o, s), t.value = o, this._updateOverlay(o, s)), this.value = o, this._internals.setFormValue(this.value), this._hasUserInteracted && this._validate(), this.dispatchEvent(new CustomEvent("nys-input", { detail: { id: this.id, value: this.value }, bubbles: true, composed: true }));
        }
        _handleFocus() {
          this.dispatchEvent(new Event("nys-focus"));
        }
        ...
        _validateButtonSlot(e) {
          var n, d;
          const t = (n = this.shadowRoot) == null ? void 0 : n.querySelector('slot[name="' + e + '"]'), o = (d = this.shadowRoot) == null ? void 0 : d.querySelector(".nys-textinput__buttoncontainer");
          if (!t || !o) return;
          const s = t.assignedElements();
          let r = false;
          s.forEach((c) => {
            c instanceof HTMLElement && c.tagName.toLowerCase() === "nys-button" && !r ? (r = true, c.setAttribute("size", "sm"), c.setAttribute("variant", "primary"), this.disabled ? c.setAttribute("disabled", "true") : c.removeAttribute("disabled")) : (console.warn("The '" + e + "' slot only accepts a single <nys-button> element. Removing invalid or extra node:", c), c.remove());
    ...
    `;
      ...
      }, K.VALID_TYPES = ["email", "number", "password", "search", "tel", "text", "url"], K.VALID_WIDTHS = ["sm", "md", "lg", "full"], K.styles = no, K.formAssociated = true, K);
      C([i({ type: String })], b.prototype, "id", 2), C([i({ type: String, reflect: true })], b.prototype, "name", 2), C([i({ reflect: true })], b.prototype, "type", 1), C([i({ type: String })], b.prototype, "label", 2), C([i({ type: String })], b.prototype, "description", 2), C([i({ type: String })], b.prototype, "placeholder", 2), C([i({ type: String })], b.prototype, "value", 2), C([i({ type: Boolean, reflect: true })], b.prototype, "disabled", 2), C([i({ type: Boolean, reflect: true })], b.prototype, "readonly", 2), C([i({ type: Boolean, reflect: true })], b.prototype, "required", 2), C([i({ type: Boolean, reflect: true })], b.prototype, "optional", 2), C([i({ type: String })], b.prototype, "_tooltip", 2), C([i({ type: String, reflect: true })], b.prototype, "form", 2), C([i({ type: String })], b.prototype, "pattern", 2), C([i({ type: Number })], b.prototype, "maxlength", 2), C([i({ reflect: true })], b.prototype, "width", 2), C([i({ type: Number })], b.prototype, "step", 2), C([i({ type: Number })], b.prototype, "min", 2), C([i({ type: Number })], b.prototype, "max", 2), C([i({ type: Boolean, reflect: true })], b.prototype, "showError", 2), C([i({ type: String })], b.prototype, "errorMessage", 2), C([D()], b.prototype, "showPassword", 2);
      let v1 = b;
      customElements.get("nys-textinput") || customElements.define("nys-textinput", v1);
      const co = g`
  :host {
...
`;
      var ho = Object.defineProperty, yo = Object.getOwnPropertyDescriptor, J = (a, e, t, o) => {
        for (var s = o > 1 ? void 0 : o ? yo(e, t) : e, r = a.length - 1, n; r >= 0; r--) (n = a[r]) && (s = (o ? n(e, t, s) : n(s)) || s);
        return o && s && ho(e, t, s), s;
      };
      let uo = 0;
      const G = (he = class extends f {
        constructor() {
          super(), this.id = "", this.name = "", this.value = "", this.label = "", this.description = "", this.form = null, this.checked = false, this.disabled = false, this.noIcon = false, this._size = "md", this._internals = this.attachInternals();
        }
        get size() {
          return this._size;
        }
        set size(e) {
          this._size = he.VALID_SIZES.includes(e) ? e : "md";
        }
        connectedCallback() {
          super.connectedCallback(), this.id || (this.id = `nys-toggle-${Date.now()}-${uo++}`);
        }
        updated(e) {
          (e.has("checked") || e.has("value")) && this._internals.setFormValue(this.checked ? this.value : null);
        }
        _emitChangeEvent() {
          this.dispatchEvent(new CustomEvent("nys-change", { detail: { id: this.id, checked: this.checked }, bubbles: true, composed: true }));
        }
        _handleFocus() {
          this.dispatchEvent(new Event("nys-focus"));
        }
    ...
    `;
      ...
      }, he.VALID_SIZES = ["sm", "md"], he.styles = co, he.formAssociated = true, he);
      J([i({ type: String })], G.prototype, "id", 2), J([i({ type: String, reflect: true })], G.prototype, "name", 2), J([i({ type: String })], G.prototype, "value", 2), J([i({ type: String })], G.prototype, "label", 2), J([i({ type: String })], G.prototype, "description", 2), J([i({ type: String, reflect: true })], G.prototype, "form", 2), J([i({ type: Boolean, reflect: true })], G.prototype, "checked", 2), J([i({ type: Boolean, reflect: true })], G.prototype, "disabled", 2), J([i({ type: Boolean })], G.prototype, "noIcon", 2), J([i({ reflect: true })], G.prototype, "size", 1);
      let f1 = G;
      customElements.get("nys-toggle") || customElements.define("nys-toggle", f1);
      const po = g`
  :host {
...
`;
      var vo = Object.defineProperty, fo = Object.getOwnPropertyDescriptor, Ue = (a, e, t, o) => {
        for (var s = o > 1 ? void 0 : o ? fo(e, t) : e, r = a.length - 1, n; r >= 0; r--) (n = a[r]) && (s = (o ? n(e, t, s) : n(s)) || s);
        return o && s && vo(e, t, s), s;
      };
      let go = 0;
      const zt = class zt extends f {
        constructor() {
          super(), this.id = "", this.text = "", this.inverted = false, this.focusable = false, this._active = false, this._userHasSetPosition = false, this._originalUserPosition = null, this._internallyUpdatingPosition = false, this._position = null, this._handleTooltipEnter = () => {
            if (this._active = true, this._addScrollListeners(), this._userHasSetPosition && this._originalUserPosition && this._doesPositionFit(this._originalUserPosition)) {
              this.position = this._originalUserPosition, this.updateComplete.then(() => {
                var t;
                const e = (t = this.shadowRoot) == null ? void 0 : t.querySelector(".nys-tooltip__content");
            ...
            if (e.key === "Escape" && this._active) {
              this._active = false, this._removeScrollListeners();
              const o = (t = this.shadowRoot) == null ? void 0 : t.querySelector(".nys-tooltip__content");
        ...
        connectedCallback() {
          super.connectedCallback(), this.id || (this.id = `nys-tooltip-${Date.now()}-${go++}`), window.addEventListener("keydown", this._handleEscapeKey);
        }
        disconnectedCallback() {
        ...
        get _firstAssignedEl() {
          var t;
          const e = (t = this.shadowRoot) == null ? void 0 : t.querySelector("slot");
          return e == null ? void 0 : e.assignedElements({ flatten: true })[0];
        }
        firstUpdated() {
          var t;
          const e = (t = this.shadowRoot) == null ? void 0 : t.querySelector("slot");
        ...
        _addScrollListeners() {
          window.addEventListener("scroll", this._handleScrollOrResize, true), window.addEventListener("resize", this._handleScrollOrResize);
        }
        _removeScrollListeners() {
          window.removeEventListener("scroll", this._handleScrollOrResize, true), window.removeEventListener("resize", this._handleScrollOrResize);
        }
        _passAria(e) {
          const t = e.tagName.toLowerCase();
          if (t.startsWith("nys-")) if (t === "nys-icon") {
            const o = e.getAttribute("ariaLabel") || "", s = o ? `${o}, ${this.text}` : this.text;
            e.setAttribute("ariaLabel", s);
          } else e.setAttribute("ariaDescription", this.text);
        }
        ...
        _doesPositionFit(e) {
          var y, p;
          const t = (y = this.shadowRoot) == null ? void 0 : y.querySelector(".nys-tooltip__wrapper"), o = (p = this.shadowRoot) == null ? void 0 : p.querySelector(".nys-tooltip__content");
          if (!t || !o || e == null) return;
          const s = t.getBoundingClientRect(), r = o.getBoundingClientRect(), n = 8, d = { top: s.top - n, left: s.left - n, bottom: window.innerHeight - s.bottom - n, right: window.innerWidth - s.right - n };
          return { top: d.top >= r.height, bottom: d.bottom >= r.height, left: d.left >= r.width, right: d.right >= r.width }[e];
        }
        async autoPositionTooltip() {
          var y, p;
          const e = (y = this.shadowRoot) == null ? void 0 : y.querySelector(".nys-tooltip__wrapper"), t = (p = this.shadowRoot) == null ? void 0 : p.querySelector(".nys-tooltip__content");
          if (!e || !t) return;
          const o = e.getBoundingClientRect(), s = 8, r = { top: o.top - s, left: o.left - s, bottom: window.innerHeight - o.bottom - s, right: window.innerWidth - o.right - s };
          let n = ["top", "bottom", "right", "left"];
          if (this._userHasSetPosition && this._originalUserPosition) {
            const h = this._originalUserPosition;
            h === "left" ? n = ["left", "right", "top", "bottom"] : h === "right" ? n = ["right", "left", "top", "bottom"] : h === "top" ? n = ["top", "bottom", "right", "left"] : h === "bottom" && (n = ["bottom", "top", "right", "left"]);
          }
          for (const h of n) if (this._doesPositionFit(h)) {
            this._setInternalPosition(h), await this.updateComplete, this._shiftTooltipIntoViewport(t);
            return;
          }
          let d = "top", c = r.top;
          for (const h of n) r[h] > c && (c = r[h], d = h);
          this._setInternalPosition(d), await this.updateComplete, this._shiftTooltipIntoViewport(t);
        }
        _setInternalPosition(e) {
          this._internallyUpdatingPosition = true, this.position = e, this._internallyUpdatingPosition = false;
        }
        _shiftTooltipIntoViewport(e) {
          var h;
          const o = ((h = this.shadowRoot) == null ? void 0 : h.querySelector(".nys-tooltip__wrapper")).getBoundingClientRect(), s = e.getBoundingClientRect(), r = o.left + o.width / 2, n = s.left < 0, d = s.right > window.innerWidth;
          this._resetTooltipPositioningStyles(e), n ? (e.style.left = "0px", e.style.transform = "none") : d && (e.style.right = "0px", e.style.left = "auto", e.style.transform = "none");
          const c = e.getBoundingClientRect(), y = (r - c.left) / c.width, p = Math.max(0, Math.min(1, y)) * 100;
    ...
    `;
      ...
      zt.styles = po;
      let ee = zt;
      Ue([i({ type: String })], ee.prototype, "id", 2), Ue([i({ type: String })], ee.prototype, "text", 2), Ue([i({ type: Boolean, reflect: true })], ee.prototype, "inverted", 2), Ue([i({ type: Boolean, reflect: true })], ee.prototype, "focusable", 2), Ue([D()], ee.prototype, "_active", 2), Ue([i({ type: String, reflect: true })], ee.prototype, "position", 1), customElements.get("nys-tooltip") || customElements.define("nys-tooltip", ee);
      const bo = g`
  :host {
...
`, _o = `<svg xmlns="http://www.w3.org/2000/svg" width="91" height="55" viewBox="0 0 91 55" fill="none">
  ...
  <path d="M69.4282 52.8659C69.4135 52.8748 69.3891 52.8858 69.3471 52.8858C69.3178 52.8858 69.2837 52.8798 69.27 52.8659L68.9889 52.1476C68.9723 52.1088 68.9459 52.0323 68.944 52.0214C68.944 52.0264 68.9371 52.1277 68.9332 52.1565L68.8815 52.9205C68.8815 52.9205 68.8561 52.9404 68.7858 52.9404C68.7155 52.9404 68.6862 52.9205 68.6862 52.9205L68.7839 51.6787C68.7839 51.6787 68.8112 51.6588 68.8776 51.6588C68.9518 51.6588 68.9781 51.6787 68.9781 51.6787L69.3042 52.5162L69.3471 52.6533C69.3481 52.6473 69.3774 52.5559 69.392 52.5162L69.7181 51.6787C69.7181 51.6787 69.7464 51.6588 69.8206 51.6588C69.886 51.6588 69.9124 51.6787 69.9124 51.6787L70.01 52.9205C70.01 52.9205 69.9807 52.9404 69.9104 52.9404C69.8401 52.9404 69.8167 52.9205 69.8167 52.9205L69.763 52.1546L69.7523 52.0194C69.7523 52.0194 69.722 52.1148 69.7093 52.1456L69.4282 52.8659Z" fill="#154973"/>
      ...
      var Co = Object.defineProperty, ze = (a, e, t, o) => {
        for (var s = void 0, r = a.length - 1, n; r >= 0; r--) (n = a[r]) && (s = n(e, t, s) || s);
        return s && Co(e, t, s), s;
      };
      const Vt = class Vt extends f {
        constructor() {
          super(...arguments), this.trustbarVisible = false, this.searchDropdownVisible = false, this.languageVisible = false, this.isSearchFocused = false, this.hideTranslate = false, this.hideSearch = false, this.languages = [["English", ""], ["Español", "es"], ["中文", "zh"], ["繁體中文", "zh-traditional"], ["Русский", "ru"], ["יידיש", "yi"], ["বাংলা", "bn"], ["한국어", "ko"], ["Kreyòl Ayisyen", "ht"], ["Italiano", "it"], ["العربية", "ar"], ["Polski", "pl"], ["Français", "fr"], ["اردو", "ur"]];
        }
        _getNysLogo() {
          return new DOMParser().parseFromString(_o, "image/svg+xml").documentElement;
        }
        _toggleTrustbar() {
          this.trustbarVisible = !this.trustbarVisible, this.trustbarVisible ? (this.languageVisible = false, this.searchDropdownVisible = false, this.updateComplete.then(() => {
            var t;
            const e = (t = this.shadowRoot) == null ? void 0 : t.getElementById("nys-unavheader__closetrustbar");
            e == null || e.focus();
          })) : this.updateComplete.then(() => {
            var t;
            const e = (t = this.shadowRoot) == null ? void 0 : t.getElementById("nys-unavheader__know--inline");
            e == null || e.focus();
          });
        }
        _toggleLanguageList() {
          this.languageVisible = !this.languageVisible, this.languageVisible && (this.trustbarVisible = false, this.searchDropdownVisible = false);
        }
        ...
        _handleSearchButton(e) {
          var s, r;
          const o = (r = ((s = this.shadowRoot) == null ? void 0 : s.getElementById(e)).value) == null ? void 0 : r.trim();
          o !== "" && this._handleSearch(o);
        }
        _handleSearch(e) {
    ...
    `;
      ...
      Vt.styles = bo;
      let W = Vt;
      ze([i({ type: Boolean })], W.prototype, "trustbarVisible"), ze([i({ type: Boolean })], W.prototype, "searchDropdownVisible"), ze([i({ type: Boolean })], W.prototype, "languageVisible"), ze([i({ type: Boolean })], W.prototype, "isSearchFocused"), ze([i({ type: Boolean })], W.prototype, "hideTranslate"), ze([i({ type: Boolean })], W.prototype, "hideSearch"), ze([i({ type: Array, reflect: true })], W.prototype, "languages"), customElements.get("nys-unavheader") || customElements.define("nys-unavheader", W);
      const mo = g`
  :host {
...
`;
      var xo = Object.defineProperty, Je = (a, e, t, o) => {
        for (var s = void 0, r = a.length - 1, n; r >= 0; r--) (n = a[r]) && (s = n(e, t, s) || s);
        return s && xo(e, t, s), s;
      };
      const Ht = class Ht extends f {
        constructor() {
          super(...arguments), this.appName = "", this.agencyName = "", this.homepageLink = "", this.slotHasContent = true, this.isMobileMenuOpen = false;
        }
        firstUpdated() {
          var t;
          const e = (t = this.shadowRoot) == null ? void 0 : t.querySelector("slot");
        ...
        async _handleSlotChange() {
          ...
          if (!e) return;
          const t = e == null ? void 0 : e.assignedNodes({ flatten: true }).filter((c) => c.nodeType === Node.ELEMENT_NODE);
          await Promise.resolve(), this.slotHasContent = t.length > 0;
          const o = (n = this.shadowRoot) == null ? void 0 : n.querySelector(".nys-globalheader__content"), s = (d = this.shadowRoot) == null ? void 0 : d.querySelector(".nys-globalheader__content-mobile");
          if (o && s) {
            o.innerHTML = "", s.innerHTML = "";
            const c = this._normalizePath(window.location.pathname + window.location.hash);
            t.forEach((y) => {
              if (y.nodeType === Node.ELEMENT_NODE) {
                const p = y.cloneNode(true), h = y.cloneNode(true);
                ["script", "iframe", "object", "embed, img"].forEach((ye) => {
                  p.querySelectorAll(ye).forEach((we) => we.remove());
                });
                const E = (ye) => {
                  const we = Array.from(ye.querySelectorAll("a"));
                  let ct = { li: null, length: 0 };
                  we.forEach((Pt) => {
                    var b1;
                    const Lo = Pt.getAttribute("href"), et = this._normalizePath(Lo);
                    et && (et === "/" && c === "/" ? ct = { li: Pt.closest("li"), length: 1 } : c != null && c.startsWith(et) && et.length > ct.length && (ct = { li: Pt.closest("li"), length: et.length }), we.forEach((Eo) => {
                      var _1;
                      return (_1 = Eo.closest("li")) == null ? void 0 : _1.classList.remove("active");
                    }), (b1 = ct.li) == null || b1.classList.add("active"));
                  });
                };
                E(p), E(h), o.appendChild(p), s.appendChild(h), y.remove();
              }
            });
          }
        }
        _normalizePath(e) {
          if (e) return e.startsWith("/") || (e = "/" + e), e.length > 1 && e.endsWith("/") && (e = e.slice(0, -1)), e.toLowerCase();
        }
        _toggleMobileMenu() {
        ...
        _listenLinkClicks() {
          var t;
          const e = (t = this.shadowRoot) == null ? void 0 : t.querySelectorAll(".nys-globalheader__content, .nys-globalheader__content-mobile");
          e == null || e.forEach((o) => {
            o == null || o.addEventListener("click", (s) => {
              const n = s.target.closest("a");
              if (!n) return;
              o.querySelectorAll("li.active").forEach((c) => c.classList.remove("active"));
              const d = n.closest("li");
    ...
    `;
      ...
      Ht.styles = mo;
      let ie = Ht;
      Je([i({ type: String })], ie.prototype, "appName"), Je([i({ type: String })], ie.prototype, "agencyName"), Je([i({ type: String })], ie.prototype, "homepageLink"), Je([D()], ie.prototype, "slotHasContent"), Je([D()], ie.prototype, "isMobileMenuOpen"), customElements.get("nys-globalheader") || customElements.define("nys-globalheader", ie);
      const wo = g`
  :host {
...
`;
      var ko = Object.defineProperty, Ct = (a, e, t, o) => {
        for (var s = void 0, r = a.length - 1, n; r >= 0; r--) (n = a[r]) && (s = n(e, t, s) || s);
        return s && ko(e, t, s), s;
      };
      const It = class It extends f {
        constructor() {
          super(...arguments), this.agencyName = "", this.homepageLink = "", this.slotHasContent = true;
        }
        firstUpdated() {
          var t;
          const e = (t = this.shadowRoot) == null ? void 0 : t.querySelector("slot");
        ...
        async _handleSlotChange() {
          ...
          const e = (r = this.shadowRoot) == null ? void 0 : r.querySelector("slot");
          if (!e) return;
          const t = e == null ? void 0 : e.assignedNodes({ flatten: true }).filter((d) => d.nodeType === Node.ELEMENT_NODE);
          await Promise.resolve(), this.slotHasContent = t.length > 0;
          const o = (n = this.shadowRoot) == null ? void 0 : n.querySelector(".nys-globalfooter__content"), s = t == null ? void 0 : t.some((d) => d.tagName === "H4");
          o && (o.classList.toggle("columns", s), o.classList.toggle("small", !s), o.innerHTML = "", t.forEach((d) => {
            if (d.nodeType === Node.ELEMENT_NODE) {
              const c = d.cloneNode(true);
              ["script", "iframe", "object", "embed", "img"].forEach((p) => {
                c.querySelectorAll(p).forEach((h) => h.remove());
              }), o.appendChild(c), d.remove();
            }
          }));
        }
        render() {
    ...
    `;
      ...
      It.styles = wo;
      let Ve = It;
      Ct([i({ type: String })], Ve.prototype, "agencyName"), Ct([i({ type: String })], Ve.prototype, "homepageLink"), Ct([D()], Ve.prototype, "slotHasContent"), customElements.get("nys-globalfooter") || customElements.define("nys-globalfooter", Ve);
      const $o = g`
  :host {
    /* Global Footer Styles */
...
</svg>`, Bt = class Bt extends f {
        _getNysLogo() {
          return new DOMParser().parseFromString(So, "image/svg+xml").documentElement;
        }
        render() {
          return l`
...
@nysds/components/dist/nysds.js:
  ...
  *)
*/
//# sourceMappingURL=node_modules_@nysds_components_dist_nysds__js.js.map
